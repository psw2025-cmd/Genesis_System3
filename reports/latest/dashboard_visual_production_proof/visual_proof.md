...
Generated: 2026-08-04T20:14:31.636Z
...
- `visible_tracker_generated_at`: `2026-08-04T19:47:45.173Z`
- `visible_tracker_status`: `BLOCKED`
- `visible_tracker_bad_tab_count`: `16`

## Screenshots
- PASS `truth.png` size=`166830`
- PASS `genesis.png` size=`254544`
- PASS `e2e_proof.png` size=`162780`
- PASS `overview.png` size=`129866`
- PASS `chain.png` size=`194909`
- PASS `signals.png` size=`143012`
- PASS `paper.png` size=`162138`
- PASS `positions.png` size=`82736`
- PASS `broker.png` size=`112789`
- PASS `performance.png` size=`114268`
- PASS `ml.png` size=`133788`
- PASS `gates.png` size=`118121`
- PASS `mobile_390x844.png` size=`84216`
