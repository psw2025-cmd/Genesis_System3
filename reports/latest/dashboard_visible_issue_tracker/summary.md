...
- [ ] Fix visible UI blocker on Genesis Brain: ASYNC_CONTENT_NOT_SETTLED after 20057ms
...
- [ ] Fix visible UI blocker on E2E Proof: ASYNC_CONTENT_NOT_SETTLED after 20057ms markers=CHECKING...
...
- [ ] Fix visible UI blocker on Trade: ASYNC_CONTENT_NOT_SETTLED after 20053ms
...
- [ ] Fix visible UI blocker on Performance: ASYNC_CONTENT_NOT_SETTLED after 20036ms
- [ ] Fix visible UI blocker on Performance: DHAN DEGRADED
- [ ] Fix visible UI blocker on ML Model: ASYNC_CONTENT_NOT_SETTLED after 20034ms
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| Truth Control | BLOCKED | OK | NO | 20058 | 13 | 5 | 0 | truth.txt |
| Genesis Brain | BLOCKED | OK | NO | 20057 | 4 | 7 | 0 | genesis.txt |
| E2E Proof | BLOCKED | OK | NO | 20057 | 18 | 5 | 0 | e2e_proof.txt |
| Overview | BLOCKED | OK | NO | 20058 | 4 | 14 | 0 | overview.txt |
| Sim Live | BLOCKED | MISSING | NO | 0 | 0 | 0 | 1 | sim_live.txt |
| Option Chain | BLOCKED | OK | NO | 20060 | 1 | 6 | 0 | chain.txt |
| Signals | BLOCKED | OK | NO | 20050 | 1 | 5 | 0 | signals.txt |
| Trade | BLOCKED | OK | NO | 20053 | 1 | 6 | 0 | trade.txt |
| Paper Trades | BLOCKED | OK | NO | 20040 | 1 | 7 | 0 | paper.txt |
| Positions | BLOCKED | OK | NO | 20039 | 1 | 7 | 0 | positions.txt |
| Performance | BLOCKED | OK | NO | 20036 | 2 | 6 | 0 | performance.txt |
| ML Model | BLOCKED | OK | NO | 20034 | 5 | 5 | 0 | ml.txt |
| Broker | BLOCKED | OK | NO | 20030 | 3 | 7 | 0 | broker.txt |
| Alerts | BLOCKED | OK | NO | 20022 | 3 | 5 | 0 | alerts.txt |
| System | BLOCKED | OK | NO | 20028 | 3 | 6 | 0 | system.txt |
| Live Gate | BLOCKED | OK | NO | 20026 | 4 | 7 | 0 | gates.txt |
## Visible blockers
...
- **Genesis Brain**: ASYNC_CONTENT_NOT_SETTLED after 20057ms
...
- **E2E Proof**: ASYNC_CONTENT_NOT_SETTLED after 20057ms markers=CHECKING...
...
- **Trade**: ASYNC_CONTENT_NOT_SETTLED after 20053ms
- **Paper Trades**: ASYNC_CONTENT_NOT_SETTLED after 20040ms
- **Positions**: ASYNC_CONTENT_NOT_SETTLED after 20039ms
- **Performance**: ASYNC_CONTENT_NOT_SETTLED after 20036ms
- **Performance**: DHAN DEGRADED
- **ML Model**: ASYNC_CONTENT_NOT_SETTLED after 20034ms
...
- **Broker**: ASYNC_CONTENT_NOT_SETTLED after 20030ms
- **Broker**: DHAN DEGRADED
- **Broker**: BLOCKED BY BACKEND FLAG
- **Alerts**: ASYNC_CONTENT_NOT_SETTLED after 20022ms
- **Alerts**: DHAN DEGRADED
- **Alerts**: Alerts unavailable: RENDER_UNAVAILABLE
- **System**: ASYNC_CONTENT_NOT_SETTLED after 20028ms
- **System**: DHAN DEGRADED
- **System**: RENDER_UNAVAILABLE
- **Live Gate**: ASYNC_CONTENT_NOT_SETTLED after 20026ms
