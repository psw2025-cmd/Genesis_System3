...
- [ ] Fix visible UI blocker on E2E Proof: ASYNC_CONTENT_NOT_SETTLED after 7017ms
...
- [ ] Fix visible UI blocker on Overview: ASYNC_CONTENT_NOT_SETTLED after 7021ms
...
- [ ] Fix visible UI blocker on Option Chain: ASYNC_CONTENT_NOT_SETTLED after 7018ms
- [ ] Fix visible UI blocker on Signals: ASYNC_CONTENT_NOT_SETTLED after 7017ms
...
- [ ] Fix visible UI blocker on Trade: ASYNC_CONTENT_NOT_SETTLED after 7020ms
- [ ] Fix visible UI blocker on Paper Trades: ASYNC_CONTENT_NOT_SETTLED after 7017ms
...
- [ ] Fix visible UI blocker on Positions: ASYNC_CONTENT_NOT_SETTLED after 7013ms
- [ ] Fix visible UI blocker on Performance: ASYNC_CONTENT_NOT_SETTLED after 7018ms
- [ ] Fix visible UI blocker on ML Model: ASYNC_CONTENT_NOT_SETTLED after 7016ms
...
- [ ] Fix visible UI blocker on Broker: ASYNC_CONTENT_NOT_SETTLED after 7016ms
...
- [ ] Fix visible UI blocker on Alerts: ASYNC_CONTENT_NOT_SETTLED after 7013ms
...
- [ ] Fix visible UI blocker on Live Gate: ASYNC_CONTENT_NOT_SETTLED after 7018ms
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| Truth Control | BLOCKED | OK | NO | 7021 | 8 | 6 | 0 | truth.txt |
| Genesis Brain | BLOCKED | OK | NO | 7020 | 4 | 7 | 0 | genesis.txt |
| E2E Proof | BLOCKED | OK | NO | 7017 | 10 | 8 | 0 | e2e_proof.txt |
| Overview | BLOCKED | OK | NO | 7021 | 6 | 14 | 0 | overview.txt |
| Sim Live | BLOCKED | MISSING | NO | 0 | 0 | 0 | 1 | sim_live.txt |
| Option Chain | BLOCKED | OK | NO | 7018 | 1 | 6 | 0 | chain.txt |
| Signals | BLOCKED | OK | NO | 7017 | 5 | 7 | 0 | signals.txt |
| Trade | BLOCKED | OK | NO | 7020 | 1 | 6 | 0 | trade.txt |
| Paper Trades | BLOCKED | OK | NO | 7017 | 4 | 21 | 0 | paper.txt |
| Positions | BLOCKED | OK | NO | 7013 | 1 | 7 | 0 | positions.txt |
| Performance | BLOCKED | OK | NO | 7018 | 1 | 6 | 0 | performance.txt |
| ML Model | BLOCKED | OK | NO | 7016 | 4 | 5 | 0 | ml.txt |
| Broker | BLOCKED | OK | NO | 7016 | 9 | 6 | 0 | broker.txt |
| Alerts | BLOCKED | OK | NO | 7013 | 1 | 5 | 0 | alerts.txt |
| System | BLOCKED | OK | NO | 7016 | 2 | 6 | 0 | system.txt |
| Live Gate | BLOCKED | OK | NO | 7018 | 3 | 7 | 0 | gates.txt |
## Visible blockers
...
- **E2E Proof**: ASYNC_CONTENT_NOT_SETTLED after 7017ms
...
- **Overview**: ASYNC_CONTENT_NOT_SETTLED after 7021ms
- **Overview**: ERROR
- **Overview**: Client ID or user generated access token is invalid or expired.
- **Overview**: STALE
- **Overview**: PEND
- **Overview**: market-session proof pending
- **Option Chain**: ASYNC_CONTENT_NOT_SETTLED after 7018ms
- **Signals**: ASYNC_CONTENT_NOT_SETTLED after 7017ms
...
- **Trade**: ASYNC_CONTENT_NOT_SETTLED after 7020ms
- **Paper Trades**: ASYNC_CONTENT_NOT_SETTLED after 7017ms
...
- **Positions**: ASYNC_CONTENT_NOT_SETTLED after 7013ms
- **Performance**: ASYNC_CONTENT_NOT_SETTLED after 7018ms
- **ML Model**: ASYNC_CONTENT_NOT_SETTLED after 7016ms
...
- **Broker**: ASYNC_CONTENT_NOT_SETTLED after 7016ms
...
- **Option Chain**: NIFTY source=dhan priority=dhan_last_verified_snapshot fetched=2026-07-15T08:38:42.848402+00:00 - Market closed — showing last verified Dhan option-chain snapshot, not live ticks.
...
- **Trade**: PAPER ONLY
- **Trade**: Paper Trades
- **Trade**: NIFTY source=dhan priority=dhan_last_verified_snapshot fetched=2026-07-15T08:38:42.848402+00:00 - Market closed — showing last verified Dhan option-chain snapshot, not live ticks.
