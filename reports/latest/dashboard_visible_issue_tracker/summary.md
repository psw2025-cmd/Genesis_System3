...
## TODO
- [ ] Fix visible UI blocker on Truth Control: ASYNC_CONTENT_NOT_SETTLED after 5017ms
...
- [ ] Fix visible UI blocker on E2E Proof: Real broker funds/margin	BLOCKED	success
- [ ] Fix visible UI blocker on E2E Proof: Real broker positions response	BLOCKED	429
...
- [ ] Fix visible UI blocker on E2E Proof: Paper/analyzer P&L endpoint	BLOCKED	success
...
- [ ] Fix visible UI blocker on E2E Proof: BANKNIFTY	BLOCKED	-	-	success	-	-	success
...
- [ ] Fix visible UI blocker on E2E Proof: /api/broker/funds	429	BLOCKED	success
- [ ] Fix visible UI blocker on E2E Proof: /api/broker/positions/live	429	BLOCKED	success
- [ ] Fix visible UI blocker on E2E Proof: /api/gain_rank	429	BLOCKED	success
- [ ] Fix visible UI blocker on E2E Proof: /api/pnl	429	BLOCKED	success
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| Truth Control | BLOCKED | OK | NO | 5017 | 8 | 5 | 0 | truth.txt |
| Genesis Brain | BLOCKED | OK | NO | 5015 | 3 | 6 | 0 | genesis.txt |
| E2E Proof | BLOCKED | OK | NO | 5012 | 25 | 6 | 0 | e2e_proof.txt |
| Overview | BLOCKED | OK | NO | 5012 | 6 | 11 | 0 | overview.txt |
| Sim Live | BLOCKED | MISSING | NO | 0 | 0 | 0 | 1 | sim_live.txt |
| Option Chain | BLOCKED | OK | NO | 5010 | 3 | 4 | 0 | chain.txt |
| Signals | BLOCKED | OK | NO | 5011 | 1 | 4 | 0 | signals.txt |
| Trade | BLOCKED | OK | NO | 5009 | 3 | 4 | 0 | trade.txt |
| Paper Trades | BLOCKED | OK | NO | 5010 | 5 | 5 | 0 | paper.txt |
| Positions | BLOCKED | OK | NO | 5009 | 1 | 6 | 0 | positions.txt |
| Performance | BLOCKED | OK | NO | 5010 | 2 | 4 | 0 | performance.txt |
| ML Model | BLOCKED | OK | NO | 5011 | 3 | 4 | 0 | ml.txt |
| Broker | BLOCKED | OK | NO | 5010 | 9 | 4 | 0 | broker.txt |
| Alerts | BLOCKED | OK | NO | 5013 | 2 | 4 | 0 | alerts.txt |
| System | BLOCKED | OK | NO | 5011 | 2 | 5 | 0 | system.txt |
| Live Gate | BLOCKED | OK | NO | 5012 | 3 | 6 | 0 | gates.txt |
## Visible blockers
- **Truth Control**: ASYNC_CONTENT_NOT_SETTLED after 5017ms
...
- **E2E Proof**: Real broker funds/margin	BLOCKED	success
- **E2E Proof**: Real broker positions response	BLOCKED	429
...
- **E2E Proof**: Paper/analyzer P&L endpoint	BLOCKED	success
...
- **E2E Proof**: BANKNIFTY	BLOCKED	-	-	success	-	-	success
...
- **E2E Proof**: /api/broker/funds	429	BLOCKED	success
- **E2E Proof**: /api/broker/positions/live	429	BLOCKED	success
- **E2E Proof**: /api/gain_rank	429	BLOCKED	success
- **E2E Proof**: /api/pnl	429	BLOCKED	success
