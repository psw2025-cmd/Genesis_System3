...
Generated: 2026-07-14T03:45:47.848Z
...
## TODO
- [ ] Fix visible UI blocker on Truth Control: ASYNC_CONTENT_NOT_SETTLED after 20046ms
...
- [ ] Fix visible UI blocker on Genesis Brain: ASYNC_CONTENT_NOT_SETTLED after 20050ms
...
- [ ] Fix visible UI blocker on Overview: ASYNC_CONTENT_NOT_SETTLED after 20049ms
...
- [ ] Fix visible UI blocker on Trade: ASYNC_CONTENT_NOT_SETTLED after 20037ms
...
- [ ] Fix visible UI blocker on Positions: ASYNC_CONTENT_NOT_SETTLED after 20032ms
- [ ] Fix visible UI blocker on Performance: ASYNC_CONTENT_NOT_SETTLED after 20040ms
- [ ] Fix visible UI blocker on ML Model: ASYNC_CONTENT_NOT_SETTLED after 20039ms
...
- [ ] Fix visible UI blocker on Broker: ASYNC_CONTENT_NOT_SETTLED after 20039ms
...
- [ ] Fix visible UI blocker on Alerts: ASYNC_CONTENT_NOT_SETTLED after 20041ms
- [ ] Fix visible UI blocker on Alerts: DHAN DEGRADED
- [ ] Fix visible UI blocker on Alerts: Alerts unavailable: RENDER_UNAVAILABLE
- [ ] Fix visible UI blocker on System: ASYNC_CONTENT_NOT_SETTLED after 20035ms
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| Truth Control | BLOCKED | OK | NO | 20046 | 8 | 5 | 0 | truth.txt |
| Genesis Brain | BLOCKED | OK | NO | 20050 | 3 | 6 | 0 | genesis.txt |
| E2E Proof | BLOCKED | OK | NO | 20046 | 17 | 7 | 0 | e2e_proof.txt |
| Overview | BLOCKED | OK | NO | 20049 | 6 | 11 | 0 | overview.txt |
| Sim Live | BLOCKED | MISSING | NO | 0 | 0 | 0 | 1 | sim_live.txt |
| Option Chain | BLOCKED | OK | NO | 20041 | 3 | 4 | 0 | chain.txt |
| Signals | BLOCKED | OK | NO | 20045 | 5 | 6 | 0 | signals.txt |
| Trade | BLOCKED | OK | NO | 20037 | 3 | 4 | 0 | trade.txt |
| Paper Trades | BLOCKED | OK | NO | 20049 | 4 | 20 | 0 | paper.txt |
| Positions | BLOCKED | OK | NO | 20032 | 1 | 6 | 0 | positions.txt |
| Performance | BLOCKED | OK | NO | 20040 | 1 | 5 | 0 | performance.txt |
| ML Model | BLOCKED | OK | NO | 20039 | 4 | 4 | 0 | ml.txt |
| Broker | BLOCKED | OK | NO | 20039 | 9 | 4 | 0 | broker.txt |
| Alerts | BLOCKED | OK | NO | 20041 | 3 | 4 | 0 | alerts.txt |
| System | BLOCKED | OK | NO | 20035 | 4 | 5 | 0 | system.txt |
| Live Gate | BLOCKED | OK | NO | 20041 | 2 | 4 | 0 | gates.txt |
## Visible blockers
- **Truth Control**: ASYNC_CONTENT_NOT_SETTLED after 20046ms
...
- **Genesis Brain**: ASYNC_CONTENT_NOT_SETTLED after 20050ms
...
- **Overview**: ASYNC_CONTENT_NOT_SETTLED after 20049ms
- **Overview**: ERROR
...
- **Trade**: ASYNC_CONTENT_NOT_SETTLED after 20037ms
...
- **Positions**: ASYNC_CONTENT_NOT_SETTLED after 20032ms
- **Performance**: ASYNC_CONTENT_NOT_SETTLED after 20040ms
- **ML Model**: ASYNC_CONTENT_NOT_SETTLED after 20039ms
...
- **Broker**: ASYNC_CONTENT_NOT_SETTLED after 20039ms
...
- **Alerts**: ASYNC_CONTENT_NOT_SETTLED after 20041ms
- **Alerts**: DHAN DEGRADED
- **Alerts**: Alerts unavailable: RENDER_UNAVAILABLE
- **System**: ASYNC_CONTENT_NOT_SETTLED after 20035ms
