...
Generated: 2026-08-04T15:23:22.840Z
...
## TODO
- [ ] Fix visible UI blocker on Truth Control: ASYNC_CONTENT_NOT_SETTLED after 5022ms
...
- [ ] Fix visible UI blocker on Genesis Brain: ASYNC_CONTENT_NOT_SETTLED after 5017ms
...
- [ ] Fix visible UI blocker on ML Model: model_accuracy_report	BLOCKED	0	N/A	0 / 1	NO_PREDICTION_SOURCE_FOUND	2026-08-04T15:09:37.656411+00:00
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| Truth Control | BLOCKED | OK | NO | 5022 | 6 | 5 | 0 | truth.txt |
| Genesis Brain | BLOCKED | OK | NO | 5017 | 4 | 6 | 0 | genesis.txt |
| E2E Proof | BLOCKED | OK | NO | 5014 | 9 | 7 | 0 | e2e_proof.txt |
| Overview | BLOCKED | OK | NO | 5012 | 5 | 13 | 0 | overview.txt |
...
| ML Model | BLOCKED | OK | NO | 5014 | 7 | 4 | 0 | ml.txt |
| Broker | BLOCKED | OK | NO | 5013 | 9 | 5 | 0 | broker.txt |
| Alerts | BLOCKED | OK | NO | 5013 | 1 | 4 | 0 | alerts.txt |
| System | BLOCKED | OK | NO | 5015 | 2 | 5 | 0 | system.txt |
| Live Gate | BLOCKED | OK | NO | 5014 | 3 | 6 | 0 | gates.txt |
## Visible blockers
- **Truth Control**: ASYNC_CONTENT_NOT_SETTLED after 5022ms
...
- **Genesis Brain**: ASYNC_CONTENT_NOT_SETTLED after 5017ms
...
- **ML Model**: model_accuracy_report	BLOCKED	0	N/A	0 / 1	NO_PREDICTION_SOURCE_FOUND	2026-08-04T15:09:37.656411+00:00
...
- **Overview**: Market closed — last verified Dhan snapshot (2026-08-04 20:15 IST)
...
- **Option Chain**: AFTER HOURS SNAPSHOT - NIFTY source=dhan priority=dhan_last_verified_snapshot age=61.2s fetched=2026-08-04T14:45:07.360782+00:00 - Market closed — last verified Dhan snapshot (2026-08-04 20:15 IST)
...
- **Trade**: LIVE OFF
- **Trade**: Paper Trades
- **Trade**: AFTER HOURS SNAPSHOT - NIFTY source=dhan priority=dhan_last_verified_snapshot age=61.2s fetched=2026-08-04T14:45:07.360782+00:00 - Market closed — last verified Dhan snapshot (2026-08-04 20:15 IST)
- **Paper Trades**: MARKET CLOSED / DATA POLLING
- **Paper Trades**: PAPER
- **Paper Trades**: LIVE OFF
- **Paper Trades**: Paper Trades
- **Paper Trades**: Paper Trading Console
- **Paper Trades**: Aligned to DhanHQ v2 Positions fields · Source: PAPER_CLOUD_SIM · Refresh: 8/4/2026, 3:24:16 PM
