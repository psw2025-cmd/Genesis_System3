...
## TODO
- [ ] Fix visible UI blocker on Truth Control: ASYNC_CONTENT_NOT_SETTLED after 5014ms
...
- [ ] Fix visible UI blocker on E2E Proof: ASYNC_CONTENT_NOT_SETTLED after 5018ms
...
- [ ] Fix visible UI blocker on Live Gate: ASYNC_CONTENT_NOT_SETTLED after 5010ms markers=CHECKING...
## Tab results
| Tab | Status | Screenshot | Settled | Settle ms | Blockers | Info | Exceptions | Text file |
|---|---|---:|---:|---:|---:|---:|---:|---|
| Truth Control | BLOCKED | OK | NO | 5014 | 8 | 5 | 0 | truth.txt |
| Genesis Brain | BLOCKED | OK | NO | 5014 | 3 | 6 | 0 | genesis.txt |
| E2E Proof | BLOCKED | OK | NO | 5018 | 17 | 7 | 0 | e2e_proof.txt |
| Overview | BLOCKED | OK | NO | 5012 | 6 | 11 | 0 | overview.txt |
| Sim Live | BLOCKED | MISSING | NO | 0 | 0 | 0 | 1 | sim_live.txt |
| Option Chain | BLOCKED | OK | NO | 5012 | 3 | 4 | 0 | chain.txt |
| Signals | BLOCKED | OK | NO | 5012 | 5 | 6 | 0 | signals.txt |
...
| Live Gate | BLOCKED | OK | NO | 5010 | 1 | 4 | 0 | gates.txt |
## Visible blockers
- **Truth Control**: ASYNC_CONTENT_NOT_SETTLED after 5014ms
...
- **E2E Proof**: ASYNC_CONTENT_NOT_SETTLED after 5018ms
...
- **Live Gate**: ASYNC_CONTENT_NOT_SETTLED after 5010ms markers=CHECKING...
## Informational lines
- **Truth Control**: PAPER
