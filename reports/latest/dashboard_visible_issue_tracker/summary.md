...
- [ ] Fix visible UI blocker on Genesis Brain: ASYNC_CONTENT_NOT_SETTLED after 20043ms
...
- [ ] Fix visible UI blocker on Option Chain: ASYNC_CONTENT_NOT_SETTLED after 20046ms
...
- [ ] Fix visible UI blocker on ML Model: ASYNC_CONTENT_NOT_SETTLED after 20051ms
...
- [ ] Fix visible UI blocker on Broker: ASYNC_CONTENT_NOT_SETTLED after 20049ms
...
- [ ] Fix visible UI blocker on Alerts: ASYNC_CONTENT_NOT_SETTLED after 20052ms
- [ ] Fix visible UI blocker on Alerts: DHAN DEGRADED
- [ ] Fix visible UI blocker on Alerts: Alerts unavailable: RENDER_UNAVAILABLE
- [ ] Fix visible UI blocker on System: ASYNC_CONTENT_NOT_SETTLED after 20048ms
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| Truth Control | BLOCKED | OK | NO | 20048 | 14 | 5 | 0 | truth.txt |
| Genesis Brain | BLOCKED | OK | NO | 20043 | 3 | 5 | 0 | genesis.txt |
| E2E Proof | BLOCKED | OK | NO | 20045 | 9 | 8 | 0 | e2e_proof.txt |
| Overview | BLOCKED | OK | NO | 20045 | 7 | 13 | 0 | overview.txt |
| Sim Live | BLOCKED | MISSING | NO | 0 | 0 | 0 | 1 | sim_live.txt |
| Option Chain | BLOCKED | OK | NO | 20046 | 2 | 6 | 0 | chain.txt |
| Signals | BLOCKED | OK | NO | 20047 | 2 | 5 | 0 | signals.txt |
| Trade | BLOCKED | OK | NO | 20061 | 2 | 6 | 0 | trade.txt |
| Paper Trades | BLOCKED | OK | NO | 20053 | 5 | 21 | 0 | paper.txt |
| Positions | BLOCKED | OK | NO | 20054 | 2 | 7 | 0 | positions.txt |
| Performance | BLOCKED | OK | NO | 20054 | 2 | 6 | 0 | performance.txt |
| ML Model | BLOCKED | OK | NO | 20051 | 5 | 5 | 0 | ml.txt |
| Broker | BLOCKED | OK | NO | 20049 | 12 | 6 | 0 | broker.txt |
| Alerts | BLOCKED | OK | NO | 20052 | 3 | 5 | 0 | alerts.txt |
| System | BLOCKED | OK | NO | 20048 | 3 | 6 | 0 | system.txt |
| Live Gate | BLOCKED | OK | NO | 20048 | 4 | 7 | 0 | gates.txt |
## Visible blockers
...
- **Genesis Brain**: ASYNC_CONTENT_NOT_SETTLED after 20043ms
...
- **Option Chain**: ASYNC_CONTENT_NOT_SETTLED after 20046ms
...
- **ML Model**: ASYNC_CONTENT_NOT_SETTLED after 20051ms
...
- **Broker**: ASYNC_CONTENT_NOT_SETTLED after 20049ms
...
- **Alerts**: ASYNC_CONTENT_NOT_SETTLED after 20052ms
- **Alerts**: DHAN DEGRADED
- **Alerts**: Alerts unavailable: RENDER_UNAVAILABLE
- **System**: ASYNC_CONTENT_NOT_SETTLED after 20048ms
