...
## TODO
- [ ] Fix visible UI blocker on Truth Control: ASYNC_CONTENT_NOT_SETTLED after 20069ms markers=CHECKING...
...
- [ ] Fix visible UI blocker on Genesis Brain: ASYNC_CONTENT_NOT_SETTLED after 20054ms
...
- [ ] Fix visible UI blocker on E2E Proof: ASYNC_CONTENT_NOT_SETTLED after 20050ms markers=CHECKING...
...
- [ ] Fix visible UI blocker on Overview: ASYNC_CONTENT_NOT_SETTLED after 20048ms
- [ ] Fix visible UI blocker on Overview: DHAN DEGRADED
- [ ] Fix visible UI blocker on Overview: API status: RENDER_UNAVAILABLE - Render/backend returned 502 for /api/broker/dhan/status. Keeping last good data where available. Retrying slowly; last good truth remains visible where available.
...
- [ ] Fix visible UI blocker on Option Chain: ASYNC_CONTENT_NOT_SETTLED after 20068ms
...
- [ ] Fix visible UI blocker on Signals: ASYNC_CONTENT_NOT_SETTLED after 20051ms
...
- [ ] Fix visible UI blocker on Paper Trades: ASYNC_CONTENT_NOT_SETTLED after 20055ms
...
- [ ] Fix visible UI blocker on Positions: ASYNC_CONTENT_NOT_SETTLED after 20054ms
- [ ] Fix visible UI blocker on Positions: DHAN DEGRADED
- [ ] Fix visible UI blocker on Performance: ASYNC_CONTENT_NOT_SETTLED after 20054ms
- [ ] Fix visible UI blocker on Performance: DHAN DEGRADED
- [ ] Fix visible UI blocker on ML Model: ASYNC_CONTENT_NOT_SETTLED after 20038ms
...
- [ ] Fix visible UI blocker on Broker: ASYNC_CONTENT_NOT_SETTLED after 20056ms
...
- [ ] Fix visible UI blocker on Alerts: ASYNC_CONTENT_NOT_SETTLED after 20051ms
- [ ] Fix visible UI blocker on Alerts: DHAN DEGRADED
- [ ] Fix visible UI blocker on Alerts: Alerts unavailable: RENDER_UNAVAILABLE
- [ ] Fix visible UI blocker on System: ASYNC_CONTENT_NOT_SETTLED after 20047ms
- [ ] Fix visible UI blocker on System: DHAN DEGRADED
- [ ] Fix visible UI blocker on System: RENDER_UNAVAILABLE
- [ ] Fix visible UI blocker on Live Gate: ASYNC_CONTENT_NOT_SETTLED after 20043ms
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| Truth Control | BLOCKED | OK | NO | 20069 | 14 | 5 | 0 | truth.txt |
| Genesis Brain | BLOCKED | OK | NO | 20054 | 3 | 5 | 0 | genesis.txt |
| E2E Proof | BLOCKED | OK | NO | 20050 | 19 | 5 | 0 | e2e_proof.txt |
| Overview | BLOCKED | OK | NO | 20048 | 7 | 12 | 0 | overview.txt |
| Sim Live | BLOCKED | MISSING | NO | 0 | 0 | 0 | 1 | sim_live.txt |
| Option Chain | BLOCKED | OK | NO | 20068 | 3 | 5 | 0 | chain.txt |
| Signals | BLOCKED | OK | NO | 20051 | 2 | 5 | 0 | signals.txt |
| Trade | BLOCKED | OK | NO | 20057 | 3 | 5 | 0 | trade.txt |
| Paper Trades | BLOCKED | OK | NO | 20055 | 6 | 6 | 0 | paper.txt |
| Positions | BLOCKED | OK | NO | 20054 | 2 | 7 | 0 | positions.txt |
| Performance | BLOCKED | OK | NO | 20054 | 2 | 6 | 0 | performance.txt |
| ML Model | BLOCKED | OK | NO | 20038 | 5 | 5 | 0 | ml.txt |
| Broker | BLOCKED | OK | NO | 20056 | 10 | 6 | 0 | broker.txt |
| Alerts | BLOCKED | OK | NO | 20051 | 3 | 5 | 0 | alerts.txt |
| System | BLOCKED | OK | NO | 20047 | 3 | 6 | 0 | system.txt |
| Live Gate | BLOCKED | OK | NO | 20043 | 4 | 7 | 0 | gates.txt |
## Visible blockers
- **Truth Control**: ASYNC_CONTENT_NOT_SETTLED after 20069ms markers=CHECKING...
...
- **Genesis Brain**: ASYNC_CONTENT_NOT_SETTLED after 20054ms
- **Genesis Brain**: DHAN DEGRADED
- **Genesis Brain**: Request failed with status code 502
- **E2E Proof**: ASYNC_CONTENT_NOT_SETTLED after 20050ms markers=CHECKING...
...
- **Overview**: ASYNC_CONTENT_NOT_SETTLED after 20048ms
- **Overview**: DHAN DEGRADED
- **Overview**: API status: RENDER_UNAVAILABLE - Render/backend returned 502 for /api/broker/dhan/status. Keeping last good data where available. Retrying slowly; last good truth remains visible where available.
- **Overview**: RENDER_UNAVAILABLE
- **Overview**: ERROR
- **Overview**: STALE
- **Overview**: FAIL
- **Option Chain**: ASYNC_CONTENT_NOT_SETTLED after 20068ms
...
- **Signals**: ASYNC_CONTENT_NOT_SETTLED after 20051ms
...
- **Paper Trades**: ASYNC_CONTENT_NOT_SETTLED after 20055ms
...
- **Positions**: ASYNC_CONTENT_NOT_SETTLED after 20054ms
- **Positions**: DHAN DEGRADED
- **Performance**: ASYNC_CONTENT_NOT_SETTLED after 20054ms
- **Performance**: DHAN DEGRADED
- **ML Model**: ASYNC_CONTENT_NOT_SETTLED after 20038ms
...
- **Broker**: ASYNC_CONTENT_NOT_SETTLED after 20056ms
...
- **Alerts**: ASYNC_CONTENT_NOT_SETTLED after 20051ms
- **Alerts**: DHAN DEGRADED
- **Alerts**: Alerts unavailable: RENDER_UNAVAILABLE
- **System**: ASYNC_CONTENT_NOT_SETTLED after 20047ms
- **System**: DHAN DEGRADED
- **System**: RENDER_UNAVAILABLE
- **Live Gate**: ASYNC_CONTENT_NOT_SETTLED after 20043ms
