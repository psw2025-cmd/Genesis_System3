...
Generated: 2026-07-13T21:35:43.205Z
...
- [ ] Fix visible UI blocker on Overview: ASYNC_CONTENT_NOT_SETTLED after 20054ms
...
- [ ] Fix visible UI blocker on Signals: ASYNC_CONTENT_NOT_SETTLED after 20046ms
- [ ] Fix visible UI blocker on Trade: ASYNC_CONTENT_NOT_SETTLED after 20056ms
- [ ] Fix visible UI blocker on Paper Trades: ASYNC_CONTENT_NOT_SETTLED after 20067ms
...
- [ ] Fix visible UI blocker on Positions: ASYNC_CONTENT_NOT_SETTLED after 20043ms
- [ ] Fix visible UI blocker on Performance: ASYNC_CONTENT_NOT_SETTLED after 20045ms
- [ ] Fix visible UI blocker on ML Model: ASYNC_CONTENT_NOT_SETTLED after 20041ms
...
- [ ] Fix visible UI blocker on Broker: ASYNC_CONTENT_NOT_SETTLED after 20051ms
- [ ] Fix visible UI blocker on Broker: BLOCKED BY BACKEND FLAG
- [ ] Fix visible UI blocker on Alerts: ASYNC_CONTENT_NOT_SETTLED after 20044ms
- [ ] Fix visible UI blocker on System: ASYNC_CONTENT_NOT_SETTLED after 20046ms
...
| E2E Proof | BLOCKED | OK | NO | 20058 | 8 | 8 | 0 | e2e_proof.txt |
| Overview | BLOCKED | OK | NO | 20054 | 4 | 14 | 0 | overview.txt |
| Sim Live | BLOCKED | MISSING | NO | 0 | 0 | 0 | 1 | sim_live.txt |
| Option Chain | BLOCKED | OK | NO | 20054 | 1 | 6 | 0 | chain.txt |
| Signals | BLOCKED | OK | NO | 20046 | 1 | 5 | 0 | signals.txt |
| Trade | BLOCKED | OK | NO | 20056 | 1 | 6 | 0 | trade.txt |
| Paper Trades | BLOCKED | OK | NO | 20067 | 4 | 21 | 0 | paper.txt |
| Positions | BLOCKED | OK | NO | 20043 | 1 | 7 | 0 | positions.txt |
| Performance | BLOCKED | OK | NO | 20045 | 1 | 6 | 0 | performance.txt |
| ML Model | BLOCKED | OK | NO | 20041 | 4 | 5 | 0 | ml.txt |
| Broker | BLOCKED | OK | NO | 20051 | 2 | 7 | 0 | broker.txt |
| Alerts | BLOCKED | OK | NO | 20044 | 1 | 5 | 0 | alerts.txt |
| System | BLOCKED | OK | NO | 20046 | 1 | 6 | 0 | system.txt |
| Live Gate | BLOCKED | OK | NO | 20045 | 3 | 7 | 0 | gates.txt |
## Visible blockers
...
- **Overview**: ASYNC_CONTENT_NOT_SETTLED after 20054ms
- **Overview**: STALE
- **Overview**: PEND
- **Overview**: market-session proof pending
- **Option Chain**: ASYNC_CONTENT_NOT_SETTLED after 20054ms
- **Signals**: ASYNC_CONTENT_NOT_SETTLED after 20046ms
- **Trade**: ASYNC_CONTENT_NOT_SETTLED after 20056ms
- **Paper Trades**: ASYNC_CONTENT_NOT_SETTLED after 20067ms
...
- **Positions**: ASYNC_CONTENT_NOT_SETTLED after 20043ms
- **Performance**: ASYNC_CONTENT_NOT_SETTLED after 20045ms
- **ML Model**: ASYNC_CONTENT_NOT_SETTLED after 20041ms
...
- **Broker**: ASYNC_CONTENT_NOT_SETTLED after 20051ms
- **Broker**: BLOCKED BY BACKEND FLAG
- **Alerts**: ASYNC_CONTENT_NOT_SETTLED after 20044ms
- **System**: ASYNC_CONTENT_NOT_SETTLED after 20046ms
