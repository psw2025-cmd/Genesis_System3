...
Generated: 2026-07-14T03:10:57.470Z
...
## TODO
- [ ] Fix visible UI blocker on Truth Control: ASYNC_CONTENT_NOT_SETTLED after 20050ms markers=CHECKING...
...
- [ ] Fix visible UI blocker on Genesis Brain: ASYNC_CONTENT_NOT_SETTLED after 20039ms
...
- [ ] Fix visible UI blocker on Overview: ASYNC_CONTENT_NOT_SETTLED after 20047ms
- [ ] Fix visible UI blocker on Overview: DHAN DEGRADED
- [ ] Fix visible UI blocker on Overview: API status: RENDER_UNAVAILABLE - Render/backend returned 502 for /api/health. Keeping last good data where available. Retrying slowly; last good truth remains visible where available.
...
- [ ] Fix visible UI blocker on Positions: ASYNC_CONTENT_NOT_SETTLED after 20035ms
...
- [ ] Fix visible UI blocker on Broker: ASYNC_CONTENT_NOT_SETTLED after 20035ms
...
- [ ] Fix visible UI blocker on System: ASYNC_CONTENT_NOT_SETTLED after 20044ms
- [ ] Fix visible UI blocker on System: DHAN DEGRADED
- [ ] Fix visible UI blocker on System: RENDER_UNAVAILABLE
- [ ] Fix visible UI blocker on Live Gate: ASYNC_CONTENT_NOT_SETTLED after 20040ms
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| Truth Control | BLOCKED | OK | NO | 20050 | 14 | 5 | 0 | truth.txt |
| Genesis Brain | BLOCKED | OK | NO | 20039 | 3 | 5 | 0 | genesis.txt |
| E2E Proof | BLOCKED | OK | NO | 20048 | 19 | 5 | 0 | e2e_proof.txt |
| Overview | BLOCKED | OK | NO | 20047 | 8 | 12 | 0 | overview.txt |
| Sim Live | BLOCKED | MISSING | NO | 0 | 0 | 0 | 1 | sim_live.txt |
| Option Chain | BLOCKED | OK | NO | 20053 | 2 | 6 | 0 | chain.txt |
| Signals | BLOCKED | OK | NO | 20043 | 2 | 5 | 0 | signals.txt |
| Trade | BLOCKED | OK | NO | 20047 | 2 | 6 | 0 | trade.txt |
| Paper Trades | BLOCKED | OK | NO | 20041 | 5 | 21 | 0 | paper.txt |
| Positions | BLOCKED | OK | NO | 20035 | 2 | 7 | 0 | positions.txt |
| Performance | BLOCKED | OK | NO | 20043 | 2 | 6 | 0 | performance.txt |
| ML Model | BLOCKED | OK | NO | 20040 | 5 | 5 | 0 | ml.txt |
| Broker | BLOCKED | OK | NO | 20035 | 12 | 6 | 0 | broker.txt |
| Alerts | BLOCKED | OK | NO | 20038 | 3 | 5 | 0 | alerts.txt |
| System | BLOCKED | OK | NO | 20044 | 3 | 6 | 0 | system.txt |
| Live Gate | BLOCKED | OK | NO | 20040 | 4 | 7 | 0 | gates.txt |
## Visible blockers
- **Truth Control**: ASYNC_CONTENT_NOT_SETTLED after 20050ms markers=CHECKING...
...
- **Genesis Brain**: ASYNC_CONTENT_NOT_SETTLED after 20039ms
...
- **Overview**: ASYNC_CONTENT_NOT_SETTLED after 20047ms
- **Overview**: DHAN DEGRADED
- **Overview**: API status: RENDER_UNAVAILABLE - Render/backend returned 502 for /api/health. Keeping last good data where available. Retrying slowly; last good truth remains visible where available.
...
- **Positions**: ASYNC_CONTENT_NOT_SETTLED after 20035ms
...
- **Broker**: ASYNC_CONTENT_NOT_SETTLED after 20035ms
...
- **System**: ASYNC_CONTENT_NOT_SETTLED after 20044ms
- **System**: DHAN DEGRADED
- **System**: RENDER_UNAVAILABLE
- **Live Gate**: ASYNC_CONTENT_NOT_SETTLED after 20040ms
