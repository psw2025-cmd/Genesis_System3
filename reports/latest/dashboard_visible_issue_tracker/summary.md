...
Generated: 2026-08-06T12:49:57.275Z
...
- [ ] Fix visible UI blocker on Overview: TOKEN_EXPIRED_OR_INVALID
...
- [ ] Fix visible UI blocker on Broker: TOKEN_EXPIRED_OR_INVALID
...
- [ ] Fix visible UI blocker on Broker: Failed to load funds: TOKEN_EXPIRED_OR_INVALID
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| Truth Control | BLOCKED | OK | NO | 5015 | 14 | 4 | 0 | truth.txt |
| Genesis Brain | BLOCKED | OK | NO | 5014 | 4 | 6 | 0 | genesis.txt |
| E2E Proof | BLOCKED | OK | NO | 5010 | 18 | 4 | 0 | e2e_proof.txt |
| Overview | BLOCKED | OK | NO | 5010 | 6 | 11 | 0 | overview.txt |
| Sim Live | BLOCKED | OK | NO | 5013 | 1 | 7 | 0 | sim_live.txt |
| Option Chain | BLOCKED | OK | NO | 5010 | 3 | 5 | 0 | chain.txt |
| Signals | BLOCKED | OK | NO | 5011 | 1 | 4 | 0 | signals.txt |
| Trade | BLOCKED | OK | NO | 5010 | 3 | 6 | 0 | trade.txt |
| Paper Trades | BLOCKED | OK | NO | 5008 | 1 | 6 | 0 | paper.txt |
| Positions | BLOCKED | OK | NO | 5009 | 1 | 6 | 0 | positions.txt |
| Performance | BLOCKED | OK | NO | 5011 | 1 | 6 | 0 | performance.txt |
| ML Model | BLOCKED | OK | NO | 5011 | 4 | 4 | 0 | ml.txt |
| Broker | BLOCKED | OK | NO | 5011 | 9 | 5 | 0 | broker.txt |
| Alerts | BLOCKED | OK | NO | 5012 | 1 | 4 | 0 | alerts.txt |
| System | BLOCKED | OK | NO | 5014 | 2 | 5 | 0 | system.txt |
...
- **Overview**: ERROR
- **Overview**: TOKEN_EXPIRED_OR_INVALID
...
- **Broker**: Failed to load funds: TOKEN_EXPIRED_OR_INVALID
