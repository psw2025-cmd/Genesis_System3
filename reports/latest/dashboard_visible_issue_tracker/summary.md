...
- [ ] Fix visible UI blocker on Truth Control: Dhan option-chain availability	BLOCKED	YES	enabled_ready=1/4, enabled_safe_no_trade=0/4, optional_ready=0/1, optional_safe_no_trade=0/1
...
- [ ] Fix visible UI blocker on Genesis Brain: ASYNC_CONTENT_NOT_SETTLED after 5023ms
...
- [ ] Fix visible UI blocker on Sim Live: ASYNC_CONTENT_NOT_SETTLED after 5016ms
- [ ] Fix visible UI blocker on Option Chain: ASYNC_CONTENT_NOT_SETTLED after 5019ms
- [ ] Fix visible UI blocker on Signals: ASYNC_CONTENT_NOT_SETTLED after 5015ms
...
- [ ] Fix visible UI blocker on Trade: ASYNC_CONTENT_NOT_SETTLED after 5020ms
...
- [ ] Fix visible UI blocker on Performance: ASYNC_CONTENT_NOT_SETTLED after 5015ms
...
- [ ] Fix visible UI blocker on Broker: ASYNC_CONTENT_NOT_SETTLED after 5015ms
- [ ] Fix visible UI blocker on Broker: BLOCKED BY BACKEND FLAG
- [ ] Fix visible UI blocker on Alerts: ASYNC_CONTENT_NOT_SETTLED after 5014ms
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| Truth Control | BLOCKED | OK | NO | 5023 | 6 | 5 | 0 | truth.txt |
| Genesis Brain | BLOCKED | OK | NO | 5023 | 4 | 6 | 0 | genesis.txt |
| E2E Proof | BLOCKED | OK | NO | 5019 | 14 | 7 | 0 | e2e_proof.txt |
| Overview | BLOCKED | OK | NO | 5018 | 2 | 13 | 0 | overview.txt |
| Sim Live | BLOCKED | OK | NO | 5016 | 1 | 7 | 0 | sim_live.txt |
| Option Chain | BLOCKED | OK | NO | 5019 | 1 | 5 | 0 | chain.txt |
| Signals | BLOCKED | OK | NO | 5015 | 6 | 5 | 0 | signals.txt |
| Trade | BLOCKED | OK | NO | 5020 | 1 | 5 | 0 | trade.txt |
| Paper Trades | BLOCKED | OK | NO | 5012 | 2 | 26 | 0 | paper.txt |
| Positions | BLOCKED | OK | NO | 5012 | 1 | 6 | 0 | positions.txt |
| Performance | BLOCKED | OK | NO | 5015 | 1 | 6 | 0 | performance.txt |
| ML Model | BLOCKED | OK | NO | 5012 | 7 | 4 | 0 | ml.txt |
| Broker | BLOCKED | OK | NO | 5015 | 2 | 6 | 0 | broker.txt |
| Alerts | BLOCKED | OK | NO | 5014 | 1 | 4 | 0 | alerts.txt |
...
- **Truth Control**: Dhan option-chain availability	BLOCKED	YES	enabled_ready=1/4, enabled_safe_no_trade=0/4, optional_ready=0/1, optional_safe_no_trade=0/1
...
- **Genesis Brain**: ASYNC_CONTENT_NOT_SETTLED after 5023ms
...
- **Overview**: PEND
- **Sim Live**: ASYNC_CONTENT_NOT_SETTLED after 5016ms
- **Option Chain**: ASYNC_CONTENT_NOT_SETTLED after 5019ms
- **Signals**: ASYNC_CONTENT_NOT_SETTLED after 5015ms
...
- **Trade**: ASYNC_CONTENT_NOT_SETTLED after 5020ms
...
- **Performance**: ASYNC_CONTENT_NOT_SETTLED after 5015ms
...
- **Broker**: ASYNC_CONTENT_NOT_SETTLED after 5015ms
- **Broker**: BLOCKED BY BACKEND FLAG
- **Alerts**: ASYNC_CONTENT_NOT_SETTLED after 5014ms
...
- **Overview**: Market closed — last verified Dhan snapshot (2026-08-05 01:47 IST)
...
- **Option Chain**: AFTER HOURS SNAPSHOT - NIFTY source=dhan priority=dhan_last_verified_snapshot age=39.1s fetched=2026-08-04T20:17:41.771389+00:00 - Market closed — last verified Dhan snapshot (2026-08-05 01:47 IST)
...
- **Trade**: LIVE OFF
- **Trade**: Paper Trades
- **Trade**: AFTER HOURS SNAPSHOT - NIFTY source=dhan priority=dhan_last_verified_snapshot age=39.1s fetched=2026-08-04T20:17:41.771389+00:00 - Market closed — last verified Dhan snapshot (2026-08-05 01:47 IST)
- **Paper Trades**: MARKET CLOSED / DATA POLLING
- **Paper Trades**: PAPER
- **Paper Trades**: LIVE OFF
- **Paper Trades**: Paper Trades
- **Paper Trades**: Paper Trading Console
- **Paper Trades**: Aligned to DhanHQ v2 Positions fields · Source: PAPER_CLOUD_SIM · Refresh: 8/4/2026, 8:23:28 PM
