...
## TODO
- [ ] Fix visible UI blocker on Truth Control: ASYNC_CONTENT_NOT_SETTLED after 5013ms markers=CHECKING...
...
- [ ] Fix visible UI blocker on Genesis Brain: ASYNC_CONTENT_NOT_SETTLED after 5008ms
...
- [ ] Fix visible UI blocker on E2E Proof: ASYNC_CONTENT_NOT_SETTLED after 5012ms markers=CHECKING...
...
- [ ] Fix visible UI blocker on Signals: ASYNC_CONTENT_NOT_SETTLED after 5007ms
...
- [ ] Fix visible UI blocker on System: ASYNC_CONTENT_NOT_SETTLED after 5006ms
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| Truth Control | BLOCKED | OK | NO | 5013 | 14 | 5 | 0 | truth.txt |
| Genesis Brain | BLOCKED | OK | NO | 5008 | 3 | 5 | 0 | genesis.txt |
| E2E Proof | BLOCKED | OK | NO | 5012 | 19 | 5 | 0 | e2e_proof.txt |
| Overview | BLOCKED | OK | NO | 5013 | 6 | 10 | 0 | overview.txt |
| Sim Live | BLOCKED | MISSING | NO | 0 | 0 | 0 | 1 | sim_live.txt |
| Option Chain | BLOCKED | OK | NO | 5007 | 4 | 6 | 0 | chain.txt |
| Signals | BLOCKED | OK | NO | 5007 | 6 | 7 | 0 | signals.txt |
| Trade | BLOCKED | OK | NO | 5009 | 4 | 6 | 0 | trade.txt |
| Paper Trades | BLOCKED | OK | NO | 5009 | 5 | 21 | 0 | paper.txt |
| Positions | BLOCKED | OK | NO | 5011 | 2 | 7 | 0 | positions.txt |
| Performance | BLOCKED | OK | NO | 5010 | 2 | 6 | 0 | performance.txt |
| ML Model | BLOCKED | OK | NO | 5011 | 5 | 5 | 0 | ml.txt |
| Broker | BLOCKED | OK | NO | 5011 | 12 | 6 | 0 | broker.txt |
| Alerts | BLOCKED | OK | NO | 5010 | 3 | 5 | 0 | alerts.txt |
| System | BLOCKED | OK | NO | 5006 | 3 | 6 | 0 | system.txt |
| Live Gate | BLOCKED | OK | NO | 5008 | 4 | 7 | 0 | gates.txt |
## Visible blockers
- **Truth Control**: ASYNC_CONTENT_NOT_SETTLED after 5013ms markers=CHECKING...
...
- **Genesis Brain**: ASYNC_CONTENT_NOT_SETTLED after 5008ms
- **Genesis Brain**: DHAN DEGRADED
- **Genesis Brain**: Request failed with status code 502
- **E2E Proof**: ASYNC_CONTENT_NOT_SETTLED after 5012ms markers=CHECKING...
...
- **Option Chain**: Stale
- **Signals**: ASYNC_CONTENT_NOT_SETTLED after 5007ms
...
- **System**: ASYNC_CONTENT_NOT_SETTLED after 5006ms
