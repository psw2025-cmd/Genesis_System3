...
Generated: 2026-07-14T12:40:25.955Z
...
## TODO
- [ ] Fix visible UI blocker on Truth Control: ASYNC_CONTENT_NOT_SETTLED after 5009ms
...
- [ ] Fix visible UI blocker on E2E Proof: ASYNC_CONTENT_NOT_SETTLED after 5007ms
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| Truth Control | BLOCKED | OK | NO | 5009 | 8 | 6 | 0 | truth.txt |
| Genesis Brain | BLOCKED | OK | NO | 5010 | 4 | 7 | 0 | genesis.txt |
| E2E Proof | BLOCKED | OK | NO | 5007 | 10 | 8 | 0 | e2e_proof.txt |
| Overview | BLOCKED | OK | NO | 5010 | 6 | 14 | 0 | overview.txt |
| Sim Live | BLOCKED | MISSING | NO | 0 | 0 | 0 | 1 | sim_live.txt |
| Option Chain | BLOCKED | OK | NO | 5012 | 1 | 6 | 0 | chain.txt |
| Signals | BLOCKED | OK | NO | 5010 | 5 | 7 | 0 | signals.txt |
| Trade | BLOCKED | OK | NO | 5010 | 1 | 6 | 0 | trade.txt |
| Paper Trades | BLOCKED | OK | NO | 5010 | 4 | 21 | 0 | paper.txt |
...
## Visible blockers
- **Truth Control**: ASYNC_CONTENT_NOT_SETTLED after 5009ms
...
- **E2E Proof**: ASYNC_CONTENT_NOT_SETTLED after 5007ms
