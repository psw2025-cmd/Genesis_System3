...
| R2/R3 | `/api/batch/chains` stayed `CHAIN_CACHE_WARMING` even if Dhan could answer | Bounded on-demand `_fill_warming_required_chains`; still never caches warming |
