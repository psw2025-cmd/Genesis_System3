...
**Updated UTC:** `2026-08-29T11:10:58.823255+00:00`  
**Base:** `https://genesis-system3-web-doq2wplepa-el.a.run.app`  
**Serving SHA:** `01a4592f4c68c120a26b4fd955d1aff655b82e33`  
**Broker:** connected=True auth=AUTH_OK secret_v=323  
**Gates:** 3/7 trade_ready=False  
**Scheduler healthy:** True  
**LIVE trading:** False  

**Counts:** OPEN=21 IN_PROGRESS=6 WATCH=2 DONE=3 · **P0 active=17**
...
|---|---|---|---|---|---|---|
| PEND-001 | P0 | **OPEN** | Serving SHA lag behind GitHub main | serving=01a4592 (compare origin/main in session) | None | MRI Auto Deploy |
| PEND-002 | P0 | **DONE** | Scheduler health UNHEALTHY | healthy=True http=200 | None | MRI Scheduler IAM |
| PEND-003 | P1 | **WATCH** | Broker AUTH_OK keep fresh | connected=True auth=AUTH_OK v=323 | None | Watch rotate |
...
| PEND-011 | P1 | **DONE** | /api/holdings /api/funds 404 | holdings=200 funds=200 | None | Deploy alias routes |
...
| PEND-019 | P0 | **DONE** | Spearman rho below 0.70 | pass=True | Do not lower threshold | Retrain/validate |
...
| PEND-028 | P1 | **OPEN** | Gates not 7/7 | gates=3/7 trade_ready=False | LIVE OFF until 7/7 | Close blockers |
...
- chain/NIFTY=200 spot=24175.65 contracts=154
