        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '16px' }}>
          ...
          <section className="card" style={{ padding: '16px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              <div style={{ fontSize: '11px', color: 'var(--text-mut)', marginBottom: '4px' }}>NO EXECUTABLE CONTROLS IN THIS WORKSPACE</div>
              ...
              <div style={{ fontSize: '10px', color: 'var(--text-sec)', padding: '8px', background: 'var(--surface-2)', borderRadius: '4px' }}>
                System-level trading inhibition is enforced by the Truth Control layer.
              </div>
            </div>
          </section>
