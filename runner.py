...
def cmd_start(refresh: int = 5, live: bool = False):
    ...
    try:
        ...
        return {"success": True, "pid": pid, "mode": "PAPER", "script": autorun_script.name}
...
def cmd_validation():
    ...
    if not validation_script:
        return {"success": False, "error": "Validation script not found", "tests_passed": 0, "total_tests": 0}
    ...
    try:
        ...
        return {"success": False, "error": "Validation timed out after 5 minutes", "tests_passed": 0, "total_tests": 0}
    except Exception as e:
        return {"success": False, "error": str(e), "tests_passed": 0, "total_tests": 0}
...
def cmd_learning():
    ...
    learning_scripts = [ROOT_DIR / "continuous_learning_system.py", ROOT_DIR / "learning" / "run_cycle.py"]
    ...
    if not learning_script:
        return {"success": False, "error": "Learning script not found"}
    ...
    try:
        ...
        return {"success": False, "error": "Learning cycle timed out after 10 minutes"}
    except Exception as e:
        return {"success": False, "error": str(e)}
