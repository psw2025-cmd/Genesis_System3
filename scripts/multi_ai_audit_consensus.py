...
def _openai(bundle: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        ...
        response = _post("https://api.openai.com/v1/chat/completions", headers, {
            ...
            "messages": [
                ...
                {"role": "user", "content": _prompt(bundle)},
            ],
        })
...
def _anthropic(bundle: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        response = _post("https://api.anthropic.com/v1/messages", headers, {
            ...
            "messages": [{"role": "user", "content": _prompt(bundle)}],
        })
        ...
        return {
            ...
            "confidence": parsed.get("confidence"), "blocking_findings": parsed.get("blocking_findings") or [],
            "rationale": str(parsed.get("rationale") or "")[:600],
            "context_1m_requested": True, "context_1m_proven": bool(ANTHROPIC_BETA),
...
def main() -> int:
    ...
    with ThreadPoolExecutor(max_workers=2) as ex:
        ...
        f_anthropic = ex.submit(_anthropic, bundle)
