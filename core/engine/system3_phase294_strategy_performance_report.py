...
REPORT_PATH = LOG_DIR / "system3_strategy_performance.md"


def run_phase294(**kwargs) -> Dict[str, Any]:
    """Run Phase 294: Strategy Performance Report."""
    errors = []
    ...
    try:
        ...
        if df.empty:
            return {
                "phase": 294,
                "status": "WARN",
                "details": "No data for strategy report",
                "outputs": {"report_file": str(REPORT_PATH)},
                "errors": [],
            }
        ...
        # Generate report
        report_lines = [
            "# System3 Strategy Performance Report\n",
        ...
        status = "OK"
        details = f"Strategy performance: {len(df)} trades, PnL: {total_pnl:.2f}"
