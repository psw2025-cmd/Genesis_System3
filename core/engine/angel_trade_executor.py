...
Outputs:
    - storage/live/angel_index_ai_trades_exec_log.csv
"""
...
TRADE_PLAN_CSV = os.path.join(LIVE_DIR, "angel_index_ai_trades_plan.csv")
EXEC_LOG_CSV = os.path.join(LIVE_DIR, "angel_index_ai_trades_exec_log.csv")
