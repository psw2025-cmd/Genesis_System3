...
Inputs:
- storage/training/angel_index_options_training.csv (baseline synthetic)
- storage/learning/angel_index_real_master_dataset.parquet (or CSV fallback)

Outputs:
- core/models/angel_one_real_blended/*_model_blended_v3.pkl
- core/models/angel_one_real_blended/*_model_blended_v3_meta.json

Config: storage/config/angel_blended_training_v3_config.json (optional)
"""
...
REAL_MASTER_CSV = LEARNING_DIR / "angel_index_real_master_dataset.csv"
CONFIG_JSON = CONFIG_DIR / "angel_blended_training_v3_config.json"
...
def train_model_for_underlying(
    ...
    meta = {
        ...
        "training_data_sources": {
            ...
            "real": "storage/learning/angel_index_real_master_dataset.parquet",
        },
