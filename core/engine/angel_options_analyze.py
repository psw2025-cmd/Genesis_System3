...
def main():
    logger.info("=== Angel One Index Options ANALYZE (simple signals) ===")
    ...
    feat_path = os.path.join(feat_dir, "angel_index_options_features.csv")
    ...
    logger.info("Angel One index options analysis completed.")
