...
OUTPUT_CSV_PATH = STORAGE_ULTRA / "phase136_angel_symbol_universe.csv"
OUTPUT_JSON_PATH = STORAGE_ULTRA / "phase136_angel_symbol_universe.json"

# Supported underlyings (hard-coded)
SUPPORTED_UNDERLYINGS = [
    {"underlying": "NIFTY", "angel_symbol": "NIFTY", "segment": "NSEFO"},
    {"underlying": "BANKNIFTY", "angel_symbol": "BANKNIFTY", "segment": "NSEFO"},
    {"underlying": "FINNIFTY", "angel_symbol": "FINNIFTY", "segment": "NSEFO"},
    {"underlying": "MIDCPNIFTY", "angel_symbol": "MIDCPNIFTY", "segment": "NSEFO"},
    {"underlying": "SENSEX", "angel_symbol": "SENSEX", "segment": "BSEFO"},
]


def run_phase136_angel_symbol_universe() -> Dict[str, Any]:
    """
...
def main():
    ...
    result = run_phase136_angel_symbol_universe()
