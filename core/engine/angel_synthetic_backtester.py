...
- Trade rules / thresholds from core/engine/angel_trade_config.py
...
from core.engine.angel_live_ai_signals import load_models_and_meta, _ensure_features_for_df
...
def run_backtest(
    ...
    # Save CSVs
    detailed_path = BACKTEST_DIR / "angel_backtest_trades_detailed.csv"
    summary_path = BACKTEST_DIR / "angel_backtest_summary.csv"
