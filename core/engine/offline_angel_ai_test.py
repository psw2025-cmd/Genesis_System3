...
def _project_root() -> str:
    ...
    Expected layout: <root>/core/engine/offline_angel_ai_test.py
    """
...
def _training_csv_path(root: str) -> str:
    return os.path.join(root, "storage", "training", "angel_index_options_training.csv")


def _models_dir(root: str) -> str:
    return os.path.join(root, "core", "models", "angel_one")
