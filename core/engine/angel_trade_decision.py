...
# angel_trade_decision.py is in PROJECT_DIR/core/engine/
...
from core.engine.angel_trade_rules import TradeRuleEngine
...
def _trades_csv() -> Path:
    return _root() / "storage" / "live" / "angel_index_ai_trades_plan.csv"
...
def main() -> None:
    root = _root()
    signals_csv = root / "storage" / "live" / "angel_index_ai_signals.csv"
