...
PNL_LOG_CSV = os.path.join(LIVE_DIR, "angel_index_ai_pnl_log.csv")  # from pnl simulator
EXEC_LOG_CSV = os.path.join(LIVE_DIR, "angel_index_ai_trades_exec_log.csv")  # from trade executor
BACKTEST_DIR = os.path.join(PROJECT_ROOT, "storage", "backtests")
BACKTEST_CSV = os.path.join(BACKTEST_DIR, "angel_backtest_trades_detailed.csv")  # from synthetic backtester
