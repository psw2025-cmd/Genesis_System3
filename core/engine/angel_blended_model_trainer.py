...
SYNTHETIC_CSV = PROJECT_ROOT / "storage" / "training" / "angel_index_options_training.csv"
REAL_CSV = PROJECT_ROOT / "storage" / "training" / "angel_index_options_real_training.csv"
BLENDED_CSV = PROJECT_ROOT / "storage" / "training" / "angel_index_options_blended_training.csv"
...
class BlendedModelTrainer:
    ...
    def build_real_training_from_live(self) -> bool:
        ...
        """
        from core.engine.build_angel_training_from_log import main as build_training_main
