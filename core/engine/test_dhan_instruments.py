...
def main():
    logger.info("=== Dhan Instruments Test ===")
    print("Testing Dhan instruments master...")
    ...
    print("Dhan instruments test completed.")
    logger.info("=== Dhan Instruments Test Completed ===")
