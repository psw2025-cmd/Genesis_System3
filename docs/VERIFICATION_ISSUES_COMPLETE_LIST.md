...
#### ⚠️ Warning #1: Phase 222 - No EV Tables Created
...
#### ⚠️ Warning #2: Phase 263 - Required Files Not Found
...
#### ⚠️ Warning #3: Historical CSV Errors - 2025-12-01.log
...
#### ⚠️ Warning #4: Historical CSV Errors - live_day_autopilot_20251201.log
...
#### ⚠️ Warning #5: Historical CSV Errors - live_day_autopilot_20251203.log (Early Run)
...
| File | Status | Issues |
|------|--------|--------|
| `angel_pnl_simulator.py` | ✅ PASSED | **0** |
| `angel_trade_decision.py` | ✅ PASSED | **0** |
| `angel_real_data_extractor.py` | ✅ PASSED | **0** |
| `system3_phase222_signal_edge.py` | ✅ PASSED | **0** |
| `system3_phase263_advanced_pnl_attribution.py` | ✅ PASSED | **0** |
...
| Phase 225 | ✅ OK | Reconciled 30 rows | **0** |
...
|------|------|--------|----------|
| `2025-12-01.log` | 2025-12-01 | ⚠️ Historical | Before fixes |
| `live_day_autopilot_20251201.log` | 2025-12-01 | ⚠️ Historical | Before fixes |
| `live_day_autopilot_20251203.log` | 2025-12-03 (21:14-21:17) | ⚠️ Historical | Early run, before fixes |
