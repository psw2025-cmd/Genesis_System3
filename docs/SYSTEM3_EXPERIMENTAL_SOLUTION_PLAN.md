...
Generated UTC: `2026-07-14T01:28:10.551981+00:00`
Status: **BLOCKED**
Issues: `414`
Fix lanes: `13`
...
### GITHUB_RENDER_FAILURE — 81 issues
...
- `reports/latest/dashboard_visible_issue_tracker/summary.json`: {"tab": "Trade", "text": "ASYNC_CONTENT_NOT_SETTLED after 20047ms"}
- `reports/latest/dashboard_visible_issue_tracker/summary.json`: {"tab": "Positions", "text": "ASYNC_CONTENT_NOT_SETTLED after 20039ms"}
- `reports/latest/dashboard_visible_issue_tracker/summary.json`: {"tab": "Performance", "text": "ASYNC_CONTENT_NOT_SETTLED after 20043ms"}
...
- `reports/latest/dashboard_visible_issue_tracker/summary.json`: {"tab": "ML Model", "text": "ASYNC_CONTENT_NOT_SETTLED after 20040ms"}
...
- `reports/latest/dashboard_visible_issue_tracker/summary.json`: {"tab": "Signals", "text": "ASYNC_CONTENT_NOT_SETTLED after 20042ms"}
...
- `reports/latest/workflow_failure_tracker/summary.json`: failed_count=23
...
Top issues:
- `reports/latest/workflow_failure_tracker/summary.json`: Fix workflow 'System3 Secure Install Credential Audit' run 29298352794 conclusion=failure commit=16c21ef3bc93d7c3b1c61025b82fa9c651a98452
- `reports/latest/workflow_failure_tracker/summary.json`: Fix workflow 'System3 Secure Install Credential Audit' run 29297317793 conclusion=failure commit=63a1f3b7078201d14c25a1348949614ab674e079
- `reports/latest/workflow_failure_tracker/summary.json`: Fix workflow 'System3 Secure Install Credential Audit' run 29297306985 conclusion=failure commit=087477f132256f2391fdf414d62d6a318bc4c038
