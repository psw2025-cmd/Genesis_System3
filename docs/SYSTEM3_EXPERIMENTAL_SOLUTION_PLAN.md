...
Generated UTC: `2026-07-13T21:48:43.464464+00:00`
Status: **BLOCKED**
Issues: `404`
Fix lanes: `13`
...
- `reports/latest/dashboard_visible_issue_tracker/summary.json`: {"tab": "Trade", "text": "ASYNC_CONTENT_NOT_SETTLED after 20056ms"}
- `reports/latest/dashboard_visible_issue_tracker/summary.json`: {"tab": "Positions", "text": "ASYNC_CONTENT_NOT_SETTLED after 20043ms"}
- `reports/latest/dashboard_visible_issue_tracker/summary.json`: {"tab": "Performance", "text": "ASYNC_CONTENT_NOT_SETTLED after 20045ms"}
...
- `reports/latest/dashboard_visible_issue_tracker/summary.json`: {"tab": "ML Model", "text": "ASYNC_CONTENT_NOT_SETTLED after 20041ms"}
...
- `reports/latest/dashboard_visible_issue_tracker/summary.json`: {"tab": "Paper Trades", "text": "ASYNC_CONTENT_NOT_SETTLED after 20067ms"}
...
- `reports/latest/dashboard_visible_issue_tracker/summary.json`: {"tab": "Signals", "text": "ASYNC_CONTENT_NOT_SETTLED after 20046ms"}
...
Top issues:
- `reports/latest/workflow_failure_tracker/summary.json`: Fix workflow 'System3 Secure Install Credential Audit' run 29286950895 conclusion=failure commit=907a6e469189b944820390c7ae67a40ce7474691
- `reports/latest/workflow_failure_tracker/summary.json`: Fix workflow 'System3 Secure Install Credential Audit' run 29286913547 conclusion=failure commit=fe9994592db3714125a636d6bd2a465fae304959
- `reports/latest/workflow_failure_tracker/summary.json`: Fix workflow 'System3 Secure Install Credential Audit' run 29286895222 conclusion=failure commit=7f8cd1587f3c29e1b47d712b34eefca8a4856c4d
- `reports/latest/workflow_failure_tracker/summary.json`: Fix workflow 'System3 Secure Install Credential Audit' run 29286867208 conclusion=failure commit=0f0fa57d3e870624bb5c1d45e52c93e516ebd516
- `reports/latest/workflow_failure_tracker/summary.json`: Fix workflow 'System3 Secure Install Credential Audit' run 29286851495 conclusion=failure commit=1cac2a8564eadd2a15b3c10f0bd118bebd3cca01
