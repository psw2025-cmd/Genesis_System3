    ...
    for expiry in expiry_dates:
        ...
        for strike in strikes:
            ...
            contracts.append({
                ...
                'iv': round(_calculate_realistic_iv(underlying_upper, strike, spot_price, days_to_expiry, call_premium), 2),  # Implied volatility (realistic bounds)
            ...
            contracts.append({
                ...
                'change': round(random.uniform(-2, 2), 2),
                'change_percent': round(random.uniform(-1, 1), 2),
                'iv': round(_calculate_realistic_iv(underlying_upper, strike, spot_price, days_to_expiry, put_premium), 2),  # Implied volatility (realistic bounds)
