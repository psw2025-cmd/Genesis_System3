@echo off
REM ====================================================================
REM GENESIS SYSTEM3 - UNIFIED AUTO MODE
REM Complete automated trading system with all features
REM ====================================================================

title Genesis System3 - Auto Mode

cd /d "%~dp0"

echo.
echo ====================================================================
echo   GENESIS SYSTEM3 - UNIFIED AUTO MODE
...
echo   [INFO] Using wrapper batch file to ensure output is visible
