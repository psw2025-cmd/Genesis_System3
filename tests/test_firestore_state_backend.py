...
def test_derived_scheduler_health_fails_enabled_job_failure_and_coverage():
    ...
    contracts = [
        ...
        ("genesis-system3-dhan-token-rotate-daily", "ENABLED", "genesis-system3-dhan-token-rotate", "*/5 * * * *", "Asia/Kolkata"),
...
def test_derived_health_allows_pending_first_run_and_historical_success():
    ...
    resources = [
        ...
        {"name": "genesis-system3-dhan-token-rotate-daily", "state": "ENABLED", "target_job": "genesis-system3-dhan-token-rotate", "schedule": "*/5 * * * *", "time_zone": "Asia/Kolkata", "target_type": "http", "target_uri_valid": True, "delivery_status_code": 0, "last_attempt_time": "2026-08-14T00:58:00Z"},
