...
class TestPhase146(unittest.TestCase):
    """Test suite for Phase 146."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 146
        cls.module_name = "core.engine.system3_phase146_index_catalog"
        cls.func_name = "run_phase146"
