...
class TestPhase187(unittest.TestCase):
    """Test suite for Phase 187."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 187
        cls.module_name = "core.engine.system3_phase187_capital_utilization_report"
        cls.func_name = "run_phase187"
