...
class TestPhase32(unittest.TestCase):
    """Test suite for Phase 32."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 32
        cls.module_name = "core.engine.system3_phase32_ultra_vs_baseline"
        cls.func_name = "run_phase32"
