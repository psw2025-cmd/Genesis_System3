...
class TestPhase267(unittest.TestCase):
    """Test suite for Phase 267."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 267
        cls.module_name = "core.engine.system3_phase267_drawdown_analyzer"
        cls.func_name = "run_phase267"
