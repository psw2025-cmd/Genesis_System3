...
class TestPhase139(unittest.TestCase):
    """Test suite for Phase 139."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 139
        cls.module_name = "core.engine.system3_phase139_lot_margin_estimator"
        cls.func_name = "run_phase139"
