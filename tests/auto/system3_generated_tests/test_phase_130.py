...
class TestPhase130(unittest.TestCase):
    """Test suite for Phase 130."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 130
        cls.module_name = "core.engine.system3_phase130_control_panel_stub"
        cls.func_name = "run_phase130"
