...
class TestPhase129(unittest.TestCase):
    """Test suite for Phase 129."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 129
        cls.module_name = "core.engine.system3_phase129_control_panel_stub"
        cls.func_name = "run_phase129"
