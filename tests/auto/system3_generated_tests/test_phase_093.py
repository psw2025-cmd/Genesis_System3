...
class TestPhase93(unittest.TestCase):
    """Test suite for Phase 93."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 93
        cls.module_name = "core.engine.system3_phase93_operator_override"
        cls.func_name = "run_phase93"
