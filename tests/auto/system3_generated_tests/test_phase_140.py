...
class TestPhase140(unittest.TestCase):
    """Test suite for Phase 140."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 140
        cls.module_name = "core.engine.system3_phase140_capital_guardrail"
        cls.func_name = "run_phase140"
