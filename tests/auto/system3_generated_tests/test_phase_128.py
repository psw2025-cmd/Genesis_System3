...
class TestPhase128(unittest.TestCase):
    """Test suite for Phase 128."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 128
        cls.module_name = "core.engine.system3_phase128_control_panel_stub"
        cls.func_name = "run_phase128"
