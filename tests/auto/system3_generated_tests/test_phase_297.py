...
class TestPhase297(unittest.TestCase):
    """Test suite for Phase 297."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 297
        cls.module_name = "core.engine.system3_phase297_trade_execution_report"
        cls.func_name = "run_phase297"
