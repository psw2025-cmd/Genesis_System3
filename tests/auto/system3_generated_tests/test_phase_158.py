...
class TestPhase158(unittest.TestCase):
    """Test suite for Phase 158."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 158
        cls.module_name = "core.engine.system3_phase158_regime_stability"
        cls.func_name = "run_phase158"
