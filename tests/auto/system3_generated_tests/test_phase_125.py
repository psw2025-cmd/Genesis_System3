...
class TestPhase125(unittest.TestCase):
    """Test suite for Phase 125."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 125
        cls.module_name = "core.engine.system3_phase125_reserved"
        cls.func_name = "run_phase125"
