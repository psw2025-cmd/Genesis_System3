...
class TestPhase83(unittest.TestCase):
    """Test suite for Phase 83."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 83
        cls.module_name = "core.engine.system3_phase83_tick_to_trade_latency"
        cls.func_name = "run_phase83"
