...
class TestPhase135(unittest.TestCase):
    """Test suite for Phase 135."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 135
        cls.module_name = "core.engine.system3_phase135_master_session_summary"
        cls.func_name = "run_phase135"
