...
class TestPhase186(unittest.TestCase):
    """Test suite for Phase 186."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 186
        cls.module_name = "core.engine.system3_phase186_risk_metrics_summary"
        cls.func_name = "run_phase186"
