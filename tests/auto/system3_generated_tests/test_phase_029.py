...
class TestPhase29(unittest.TestCase):
    """Test suite for Phase 29."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 29
        cls.module_name = "core.ultra.phase29_sensitivity"
        cls.func_name = "run_phase29"
