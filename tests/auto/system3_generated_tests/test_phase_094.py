...
class TestPhase94(unittest.TestCase):
    """Test suite for Phase 94."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 94
        cls.module_name = "core.engine.system3_phase94_notification_engine"
        cls.func_name = "run_phase94"
