...
class TestPhase166(unittest.TestCase):
    """Test suite for Phase 166."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 166
        cls.module_name = "core.engine.system3_phase166_underlying_performance"
        cls.func_name = "run_phase166"
