...
class TestPhase120(unittest.TestCase):
    """Test suite for Phase 120."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 120
        cls.module_name = "core.engine.system3_phase120_eod_live_summary_pack"
        cls.func_name = "run_phase120"
