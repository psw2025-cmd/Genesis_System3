...
class TestPhase192(unittest.TestCase):
    """Test suite for Phase 192."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 192
        cls.module_name = "core.engine.system3_phase192_model_comparison_report"
        cls.func_name = "run_phase192"
