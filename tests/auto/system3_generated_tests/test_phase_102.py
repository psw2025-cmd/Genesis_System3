...
class TestPhase102(unittest.TestCase):
    """Test suite for Phase 102."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 102
        cls.module_name = "core.engine.system3_phase102_order_ledger_schema"
        cls.func_name = "run_phase102"
