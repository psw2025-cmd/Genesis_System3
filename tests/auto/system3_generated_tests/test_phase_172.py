...
class TestPhase172(unittest.TestCase):
    """Test suite for Phase 172."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 172
        cls.module_name = "core.engine.system3_phase172_schema_guard"
        cls.func_name = "run_phase172"
