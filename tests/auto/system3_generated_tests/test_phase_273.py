...
class TestPhase273(unittest.TestCase):
    """Test suite for Phase 273."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 273
        cls.module_name = "core.engine.system3_phase273_model_ensemble_builder"
        cls.func_name = "run_phase273"
