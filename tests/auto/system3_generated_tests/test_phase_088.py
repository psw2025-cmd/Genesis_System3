...
class TestPhase88(unittest.TestCase):
    """Test suite for Phase 88."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 88
        cls.module_name = "core.engine.system3_phase88_portfolio_risk"
        cls.func_name = "run_phase88"
