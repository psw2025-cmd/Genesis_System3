...
class TestPhase200(unittest.TestCase):
    """Test suite for Phase 200."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 200
        cls.module_name = "core.engine.system3_phase200_master_status_snapshot"
        cls.func_name = "run_phase200"
