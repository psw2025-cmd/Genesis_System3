...
class TestPhase294(unittest.TestCase):
    """Test suite for Phase 294."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 294
        cls.module_name = "core.engine.system3_phase294_strategy_performance_report"
        cls.func_name = "run_phase294"
