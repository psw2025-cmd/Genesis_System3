...
class TestPhase33(unittest.TestCase):
    """Test suite for Phase 33."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 33
        cls.module_name = "core.engine.system3_phase33_promotion_planner"
        cls.func_name = "run_phase33"
