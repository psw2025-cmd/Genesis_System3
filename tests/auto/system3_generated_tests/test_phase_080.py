...
class TestPhase80(unittest.TestCase):
    """Test suite for Phase 80."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 80
        cls.module_name = "core.engine.system3_phase80_geni_evolution_status"
        cls.func_name = "run_phase80"
