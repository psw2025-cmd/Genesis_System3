...
class TestPhase173(unittest.TestCase):
    """Test suite for Phase 173."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 173
        cls.module_name = "core.engine.system3_phase173_holiday_detection"
        cls.func_name = "run_phase173"
