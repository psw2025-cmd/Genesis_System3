...
class TestPhase142(unittest.TestCase):
    """Test suite for Phase 142."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 142
        cls.module_name = "core.engine.system3_phase142_slippage_calculator"
        cls.func_name = "run_phase142"
