...
class TestPhase264(unittest.TestCase):
    """Test suite for Phase 264."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 264
        cls.module_name = "core.engine.system3_phase264_signal_quality_metrics"
        cls.func_name = "run_phase264"
