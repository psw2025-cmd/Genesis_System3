...
class TestPhase87(unittest.TestCase):
    """Test suite for Phase 87."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 87
        cls.module_name = "core.engine.system3_phase87_expected_value"
        cls.func_name = "run_phase87"
