...
class TestPhase134(unittest.TestCase):
    """Test suite for Phase 134."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 134
        cls.module_name = "core.engine.system3_phase134_master_session_plan"
        cls.func_name = "run_phase134"
