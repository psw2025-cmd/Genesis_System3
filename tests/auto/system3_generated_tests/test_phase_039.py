...
class TestPhase39(unittest.TestCase):
    """Test suite for Phase 39."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 39
        cls.module_name = "core.engine.system3_phase39_shadow_campaign"
        cls.func_name = "run_phase39"
