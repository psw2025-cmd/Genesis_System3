...
class TestPhase156(unittest.TestCase):
    """Test suite for Phase 156."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 156
        cls.module_name = "core.engine.system3_phase156_capital_curve_analysis"
        cls.func_name = "run_phase156"
