...
class TestPhase160(unittest.TestCase):
    """Test suite for Phase 160."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 160
        cls.module_name = "core.engine.system3_phase160_error_attribution"
        cls.func_name = "run_phase160"
