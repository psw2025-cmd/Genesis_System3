...
class TestPhase97(unittest.TestCase):
    """Test suite for Phase 97."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 97
        cls.module_name = "core.engine.system3_phase97_backup_recovery"
        cls.func_name = "run_phase97"
