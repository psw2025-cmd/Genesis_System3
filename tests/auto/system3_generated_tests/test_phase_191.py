...
class TestPhase191(unittest.TestCase):
    """Test suite for Phase 191."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 191
        cls.module_name = "core.engine.system3_phase191_feature_importance_summary"
        cls.func_name = "run_phase191"
