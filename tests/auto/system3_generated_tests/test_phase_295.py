...
class TestPhase295(unittest.TestCase):
    """Test suite for Phase 295."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 295
        cls.module_name = "core.engine.system3_phase295_risk_metrics_report"
        cls.func_name = "run_phase295"
