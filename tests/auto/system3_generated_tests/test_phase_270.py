...
class TestPhase270(unittest.TestCase):
    """Test suite for Phase 270."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 270
        cls.module_name = "core.engine.system3_phase270_regime_performance_comparison"
        cls.func_name = "run_phase270"
