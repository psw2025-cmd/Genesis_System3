...
class TestPhase224(unittest.TestCase):
    """Test suite for Phase 224."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 224
        cls.module_name = "core.engine.system3_phase224_score_attribution"
        cls.func_name = "run_phase224"
