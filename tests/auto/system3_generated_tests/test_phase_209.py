...
class TestPhase209(unittest.TestCase):
    """Test suite for Phase 209."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 209
        cls.module_name = "core.engine.system3_phase209_duplicate_purger"
        cls.func_name = "run_phase209"
