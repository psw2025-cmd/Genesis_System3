...
class TestPhase190(unittest.TestCase):
    """Test suite for Phase 190."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 190
        cls.module_name = "core.engine.system3_phase190_correlation_analysis"
        cls.func_name = "run_phase190"
