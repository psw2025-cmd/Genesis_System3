...
class TestPhase147(unittest.TestCase):
    """Test suite for Phase 147."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 147
        cls.module_name = "core.engine.system3_phase147_config_inventory"
        cls.func_name = "run_phase147"
