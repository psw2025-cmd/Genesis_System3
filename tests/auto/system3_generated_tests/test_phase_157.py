...
class TestPhase157(unittest.TestCase):
    """Test suite for Phase 157."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 157
        cls.module_name = "core.engine.system3_phase157_misfire_breakdown"
        cls.func_name = "run_phase157"
