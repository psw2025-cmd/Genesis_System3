...
class TestPhase25(unittest.TestCase):
    """Test suite for Phase 25."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 25
        cls.module_name = "core.ultra.phase25_stoploss_engine"
        cls.func_name = "run_phase25"
