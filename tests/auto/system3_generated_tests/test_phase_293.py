...
class TestPhase293(unittest.TestCase):
    """Test suite for Phase 293."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 293
        cls.module_name = "core.engine.system3_phase293_monthly_analytics_report"
        cls.func_name = "run_phase293"
