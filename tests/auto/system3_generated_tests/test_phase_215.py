...
class TestPhase215(unittest.TestCase):
    """Test suite for Phase 215."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 215
        cls.module_name = "core.engine.system3_phase215_overfit_sentinel"
        cls.func_name = "run_phase215"
