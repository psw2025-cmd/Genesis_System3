...
class TestPhase279(unittest.TestCase):
    """Test suite for Phase 279."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 279
        cls.module_name = "core.engine.system3_phase279_portfolio_rebalancer"
        cls.func_name = "run_phase279"
