...
class TestPhase182(unittest.TestCase):
    """Test suite for Phase 182."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 182
        cls.module_name = "core.engine.system3_phase182_data_quality_report"
        cls.func_name = "run_phase182"
