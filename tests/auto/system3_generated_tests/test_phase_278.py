...
class TestPhase278(unittest.TestCase):
    """Test suite for Phase 278."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 278
        cls.module_name = "core.engine.system3_phase278_exit_timing_optimizer"
        cls.func_name = "run_phase278"
