...
class TestPhase222(unittest.TestCase):
    """Test suite for Phase 222."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 222
        cls.module_name = "core.engine.system3_phase222_signal_edge"
        cls.func_name = "run_phase222"
