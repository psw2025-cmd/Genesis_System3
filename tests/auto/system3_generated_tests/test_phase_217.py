...
class TestPhase217(unittest.TestCase):
    """Test suite for Phase 217."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 217
        cls.module_name = "core.engine.system3_phase217_vol_regime"
        cls.func_name = "run_phase217"
