...
class TestPhase197(unittest.TestCase):
    """Test suite for Phase 197."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 197
        cls.module_name = "core.engine.system3_phase197_micro_capital_test_plan"
        cls.func_name = "run_phase197"
