...
class TestPhase99(unittest.TestCase):
    """Test suite for Phase 99."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 99
        cls.module_name = "core.engine.system3_phase99_version_freeze"
        cls.func_name = "run_phase99"
