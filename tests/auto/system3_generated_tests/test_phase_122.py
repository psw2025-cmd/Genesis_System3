...
class TestPhase122(unittest.TestCase):
    """Test suite for Phase 122."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 122
        cls.module_name = "core.engine.system3_phase122_reserved"
        cls.func_name = "run_phase122"
