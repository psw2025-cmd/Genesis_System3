...
class TestPhase124(unittest.TestCase):
    """Test suite for Phase 124."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 124
        cls.module_name = "core.engine.system3_phase124_reserved"
        cls.func_name = "run_phase124"
