...
class TestPhase42(unittest.TestCase):
    """Test suite for Phase 42."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 42
        cls.module_name = "core.engine.system3_phase42_snapshot_manager"
        cls.func_name = "run_phase42"
