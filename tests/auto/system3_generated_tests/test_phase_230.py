...
class TestPhase230(unittest.TestCase):
    """Test suite for Phase 230."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 230
        cls.module_name = "core.engine.system3_phase230_ai_fallback_audit"
        cls.func_name = "run_phase230"
