...
class TestPhase203(unittest.TestCase):
    """Test suite for Phase 203."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 203
        cls.module_name = "core.engine.system3_phase203_config_consistency"
        cls.func_name = "run_phase203"
