...
class TestPhase195(unittest.TestCase):
    """Test suite for Phase 195."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 195
        cls.module_name = "core.engine.system3_phase195_master_summary_report"
        cls.func_name = "run_phase195"
