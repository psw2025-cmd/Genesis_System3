...
class TestPhase114(unittest.TestCase):
    """Test suite for Phase 114."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 114
        cls.module_name = "core.engine.system3_phase114_live_session_health"
        cls.func_name = "run_phase114"
