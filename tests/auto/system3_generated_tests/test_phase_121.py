...
class TestPhase121(unittest.TestCase):
    """Test suite for Phase 121."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 121
        cls.module_name = "core.engine.system3_phase121_reserved"
        cls.func_name = "run_phase121"
