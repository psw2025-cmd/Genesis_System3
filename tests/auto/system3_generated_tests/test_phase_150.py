...
class TestPhase150(unittest.TestCase):
    """Test suite for Phase 150."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 150
        cls.module_name = "core.engine.system3_phase150_dependency_graph"
        cls.func_name = "run_phase150"
