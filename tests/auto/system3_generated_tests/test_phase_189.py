...
class TestPhase189(unittest.TestCase):
    """Test suite for Phase 189."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 189
        cls.module_name = "core.engine.system3_phase189_time_series_analysis"
        cls.func_name = "run_phase189"
