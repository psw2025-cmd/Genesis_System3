...
class TestPhase111(unittest.TestCase):
    """Test suite for Phase 111."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 111
        cls.module_name = "core.engine.system3_phase111_live_session_brain"
        cls.func_name = "run_phase111"
