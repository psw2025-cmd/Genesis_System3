...
class TestPhase280(unittest.TestCase):
    """Test suite for Phase 280."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 280
        cls.module_name = "core.engine.system3_phase280_strategy_backtester"
        cls.func_name = "run_phase280"
