...
class TestPhase145(unittest.TestCase):
    """Test suite for Phase 145."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 145
        cls.module_name = "core.engine.system3_phase145_one_lot_health_report"
        cls.func_name = "run_phase145"
