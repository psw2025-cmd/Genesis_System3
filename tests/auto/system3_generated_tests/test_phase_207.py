...
class TestPhase207(unittest.TestCase):
    """Test suite for Phase 207."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 207
        cls.module_name = "core.engine.system3_phase207_hotfix_registry"
        cls.func_name = "run_phase207"
