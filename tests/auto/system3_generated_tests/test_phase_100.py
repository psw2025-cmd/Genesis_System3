...
class TestPhase100(unittest.TestCase):
    """Test suite for Phase 100."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 100
        cls.module_name = "core.engine.system3_phase100_final_certification"
        cls.func_name = "run_phase100"
