...
class TestPhase299(unittest.TestCase):
    """Test suite for Phase 299."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 299
        cls.module_name = "core.engine.system3_phase299_master_summary_report"
        cls.func_name = "run_phase299"
