...
class TestPhase137(unittest.TestCase):
    """Test suite for Phase 137."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 137
        cls.module_name = "core.engine.system3_phase137_expiry_calendar_map"
        cls.func_name = "run_phase137"
