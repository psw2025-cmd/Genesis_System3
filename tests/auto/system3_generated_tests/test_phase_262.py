...
class TestPhase262(unittest.TestCase):
    """Test suite for Phase 262."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 262
        cls.module_name = "core.engine.system3_phase262_multitimeframe_consistency"
        cls.func_name = "run_phase262"
