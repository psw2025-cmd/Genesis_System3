...
class TestPhase86(unittest.TestCase):
    """Test suite for Phase 86."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 86
        cls.module_name = "core.engine.system3_phase86_position_sizing"
        cls.func_name = "run_phase86"
