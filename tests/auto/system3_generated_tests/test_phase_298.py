...
class TestPhase298(unittest.TestCase):
    """Test suite for Phase 298."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 298
        cls.module_name = "core.engine.system3_phase298_system_status_report"
        cls.func_name = "run_phase298"
