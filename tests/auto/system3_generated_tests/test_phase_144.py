...
class TestPhase144(unittest.TestCase):
    """Test suite for Phase 144."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 144
        cls.module_name = "core.engine.system3_phase144_pnl_vs_execution_scenario"
        cls.func_name = "run_phase144"
