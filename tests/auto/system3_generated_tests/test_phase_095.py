...
class TestPhase95(unittest.TestCase):
    """Test suite for Phase 95."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 95
        cls.module_name = "core.engine.system3_phase95_operator_activity_log"
        cls.func_name = "run_phase95"
