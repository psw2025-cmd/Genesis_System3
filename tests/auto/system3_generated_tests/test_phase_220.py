...
class TestPhase220(unittest.TestCase):
    """Test suite for Phase 220."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 220
        cls.module_name = "core.engine.system3_phase220_correlation_map"
        cls.func_name = "run_phase220"
