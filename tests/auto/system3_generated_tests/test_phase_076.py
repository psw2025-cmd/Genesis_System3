...
class TestPhase76(unittest.TestCase):
    """Test suite for Phase 76."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 76
        cls.module_name = "core.engine.system3_phase76_geni_self_critique"
        cls.func_name = "run_phase76"
