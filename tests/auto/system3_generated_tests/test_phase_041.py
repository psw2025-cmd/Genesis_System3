...
class TestPhase41(unittest.TestCase):
    """Test suite for Phase 41."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 41
        cls.module_name = "core.engine.system3_phase41_promotion_executor"
        cls.func_name = "run_phase41"
