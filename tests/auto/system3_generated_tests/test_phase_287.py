...
class TestPhase287(unittest.TestCase):
    """Test suite for Phase 287."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 287
        cls.module_name = "core.engine.system3_phase287_resource_usage_monitor"
        cls.func_name = "run_phase287"
