...
class TestPhase26(unittest.TestCase):
    """Test suite for Phase 26."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 26
        cls.module_name = "core.ultra.phase26_target_engine"
        cls.func_name = "run_phase26"
