...
class TestPhase271(unittest.TestCase):
    """Test suite for Phase 271."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 271
        cls.module_name = "core.engine.system3_phase271_hyperparameter_search"
        cls.func_name = "run_phase271"
