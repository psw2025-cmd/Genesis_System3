...
class TestPhase180(unittest.TestCase):
    """Test suite for Phase 180."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 180
        cls.module_name = "core.engine.system3_phase180_error_rate_analysis"
        cls.func_name = "run_phase180"
