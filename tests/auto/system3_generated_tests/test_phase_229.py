...
class TestPhase229(unittest.TestCase):
    """Test suite for Phase 229."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 229
        cls.module_name = "core.engine.system3_phase229_schema_guard"
        cls.func_name = "run_phase229"
