...
class TestPhase212(unittest.TestCase):
    """Test suite for Phase 212."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 212
        cls.module_name = "core.engine.system3_phase212_label_quality"
        cls.func_name = "run_phase212"
