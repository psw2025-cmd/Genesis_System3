...
class TestPhase101(unittest.TestCase):
    """Test suite for Phase 101."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 101
        cls.module_name = "core.engine.system3_phase101_live_trade_config_check"
        cls.func_name = "run_phase101"
