...
class TestPhase184(unittest.TestCase):
    """Test suite for Phase 184."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 184
        cls.module_name = "core.engine.system3_phase184_signal_quality_metrics"
        cls.func_name = "run_phase184"
