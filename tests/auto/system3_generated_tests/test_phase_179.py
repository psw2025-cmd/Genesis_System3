...
class TestPhase179(unittest.TestCase):
    """Test suite for Phase 179."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 179
        cls.module_name = "core.engine.system3_phase179_resource_usage_summary"
        cls.func_name = "run_phase179"
