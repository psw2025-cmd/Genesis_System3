...
class TestPhase78(unittest.TestCase):
    """Test suite for Phase 78."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 78
        cls.module_name = "core.engine.system3_phase78_geni_consensus"
        cls.func_name = "run_phase78"
