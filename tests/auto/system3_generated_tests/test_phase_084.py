...
class TestPhase84(unittest.TestCase):
    """Test suite for Phase 84."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 84
        cls.module_name = "core.engine.system3_phase84_resource_optimizer"
        cls.func_name = "run_phase84"
