...
class TestPhase123(unittest.TestCase):
    """Test suite for Phase 123."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 123
        cls.module_name = "core.engine.system3_phase123_reserved"
        cls.func_name = "run_phase123"
