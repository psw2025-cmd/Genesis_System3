...
class TestPhase115(unittest.TestCase):
    """Test suite for Phase 115."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 115
        cls.module_name = "core.engine.system3_phase115_intraday_alert_summary"
        cls.func_name = "run_phase115"
