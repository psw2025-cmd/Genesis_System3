...
class TestPhase272(unittest.TestCase):
    """Test suite for Phase 272."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 272
        cls.module_name = "core.engine.system3_phase272_feature_selection_optimizer"
        cls.func_name = "run_phase272"
