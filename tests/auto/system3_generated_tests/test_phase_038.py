...
class TestPhase38(unittest.TestCase):
    """Test suite for Phase 38."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 38
        cls.module_name = "core.engine.system3_phase38_governance_summary"
        cls.func_name = "run_phase38"
