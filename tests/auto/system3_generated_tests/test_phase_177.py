...
class TestPhase177(unittest.TestCase):
    """Test suite for Phase 177."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 177
        cls.module_name = "core.engine.system3_phase177_performance_trends"
        cls.func_name = "run_phase177"
