...
class TestPhase291(unittest.TestCase):
    """Test suite for Phase 291."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 291
        cls.module_name = "core.engine.system3_phase291_daily_performance_report"
        cls.func_name = "run_phase291"
