...
class TestPhase91(unittest.TestCase):
    """Test suite for Phase 91."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 91
        cls.module_name = "core.engine.system3_phase91_live_dashboard"
        cls.func_name = "run_phase91"
