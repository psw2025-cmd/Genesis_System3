...
class TestPhase92(unittest.TestCase):
    """Test suite for Phase 92."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 92
        cls.module_name = "core.engine.system3_phase92_session_replay"
        cls.func_name = "run_phase92"
