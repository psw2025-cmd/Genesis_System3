...
class TestPhase296(unittest.TestCase):
    """Test suite for Phase 296."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 296
        cls.module_name = "core.engine.system3_phase296_model_performance_report"
        cls.func_name = "run_phase296"
