...
class TestPhase292(unittest.TestCase):
    """Test suite for Phase 292."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 292
        cls.module_name = "core.engine.system3_phase292_weekly_summary_report"
        cls.func_name = "run_phase292"
