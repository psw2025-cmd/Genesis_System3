...
class TestPhase266(unittest.TestCase):
    """Test suite for Phase 266."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 266
        cls.module_name = "core.engine.system3_phase266_capital_efficiency_tracker"
        cls.func_name = "run_phase266"
