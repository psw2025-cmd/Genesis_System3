...
class TestPhase162(unittest.TestCase):
    """Test suite for Phase 162."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 162
        cls.module_name = "core.engine.system3_phase162_capital_efficiency"
        cls.func_name = "run_phase162"
