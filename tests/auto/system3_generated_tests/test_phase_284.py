...
class TestPhase284(unittest.TestCase):
    """Test suite for Phase 284."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 284
        cls.module_name = "core.engine.system3_phase284_alert_aggregator"
        cls.func_name = "run_phase284"
