...
class TestPhase171(unittest.TestCase):
    """Test suite for Phase 171."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 171
        cls.module_name = "core.engine.system3_phase171_file_backup"
        cls.func_name = "run_phase171"
