...
class TestPhase113(unittest.TestCase):
    """Test suite for Phase 113."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 113
        cls.module_name = "core.engine.system3_phase113_kill_switch_monitor"
        cls.func_name = "run_phase113"
