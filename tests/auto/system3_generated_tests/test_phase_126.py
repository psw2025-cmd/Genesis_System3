...
class TestPhase126(unittest.TestCase):
    """Test suite for Phase 126."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 126
        cls.module_name = "core.engine.system3_phase126_control_panel_stub"
        cls.func_name = "run_phase126"
