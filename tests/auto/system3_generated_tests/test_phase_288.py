...
class TestPhase288(unittest.TestCase):
    """Test suite for Phase 288."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 288
        cls.module_name = "core.engine.system3_phase288_latency_monitor"
        cls.func_name = "run_phase288"
