...
class TestPhase138(unittest.TestCase):
    """Test suite for Phase 138."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 138
        cls.module_name = "core.engine.system3_phase138_risk_tier_assignment"
        cls.func_name = "run_phase138"
