...
class TestPhase165(unittest.TestCase):
    """Test suite for Phase 165."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 165
        cls.module_name = "core.engine.system3_phase165_risk_reward"
        cls.func_name = "run_phase165"
