...
class TestPhase205(unittest.TestCase):
    """Test suite for Phase 205."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 205
        cls.module_name = "core.engine.system3_phase205_broker_selftest"
        cls.func_name = "run_phase205"
