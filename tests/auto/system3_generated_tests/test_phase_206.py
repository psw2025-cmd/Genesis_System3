...
class TestPhase206(unittest.TestCase):
    """Test suite for Phase 206."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 206
        cls.module_name = "core.engine.system3_phase206_model_compatibility"
        cls.func_name = "run_phase206"
