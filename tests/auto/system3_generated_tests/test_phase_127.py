...
class TestPhase127(unittest.TestCase):
    """Test suite for Phase 127."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 127
        cls.module_name = "core.engine.system3_phase127_control_panel_stub"
        cls.func_name = "run_phase127"
