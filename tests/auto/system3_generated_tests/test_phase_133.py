...
class TestPhase133(unittest.TestCase):
    """Test suite for Phase 133."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 133
        cls.module_name = "core.engine.system3_phase133_master_safety_guard"
        cls.func_name = "run_phase133"
