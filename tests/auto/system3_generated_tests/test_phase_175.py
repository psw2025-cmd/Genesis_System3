...
class TestPhase175(unittest.TestCase):
    """Test suite for Phase 175."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 175
        cls.module_name = "core.engine.system3_phase175_exception_catalog"
        cls.func_name = "run_phase175"
