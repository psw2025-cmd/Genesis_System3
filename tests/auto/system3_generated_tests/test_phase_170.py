...
class TestPhase170(unittest.TestCase):
    """Test suite for Phase 170."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 170
        cls.module_name = "core.engine.system3_phase170_stability_metrics"
        cls.func_name = "run_phase170"
