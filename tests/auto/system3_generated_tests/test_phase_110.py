...
class TestPhase110(unittest.TestCase):
    """Test suite for Phase 110."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 110
        cls.module_name = "core.engine.system3_phase110_exit_rule_builder"
        cls.func_name = "run_phase110"
