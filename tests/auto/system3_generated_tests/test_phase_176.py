...
class TestPhase176(unittest.TestCase):
    """Test suite for Phase 176."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 176
        cls.module_name = "core.engine.system3_phase176_long_run_summary"
        cls.func_name = "run_phase176"
