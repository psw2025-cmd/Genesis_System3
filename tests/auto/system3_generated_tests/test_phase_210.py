...
class TestPhase210(unittest.TestCase):
    """Test suite for Phase 210."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 210
        cls.module_name = "core.engine.system3_phase210_timegap_analyzer"
        cls.func_name = "run_phase210"
