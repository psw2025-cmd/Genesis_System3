...
class TestPhase213(unittest.TestCase):
    """Test suite for Phase 213."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 213
        cls.module_name = "core.engine.system3_phase213_training_window"
        cls.func_name = "run_phase213"
