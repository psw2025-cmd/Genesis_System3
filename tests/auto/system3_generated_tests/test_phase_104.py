...
class TestPhase104(unittest.TestCase):
    """Test suite for Phase 104."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 104
        cls.module_name = "core.engine.system3_phase104_tradeplan_to_orders"
        cls.func_name = "run_phase104"
