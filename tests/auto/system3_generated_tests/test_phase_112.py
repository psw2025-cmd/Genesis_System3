...
class TestPhase112(unittest.TestCase):
    """Test suite for Phase 112."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 112
        cls.module_name = "core.engine.system3_phase112_session_loop_controller"
        cls.func_name = "run_phase112"
