...
class TestPhase198(unittest.TestCase):
    """Test suite for Phase 198."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 198
        cls.module_name = "core.engine.system3_phase198_human_gate_checklist"
        cls.func_name = "run_phase198"
