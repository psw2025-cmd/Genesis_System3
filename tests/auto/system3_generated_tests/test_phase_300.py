...
class TestPhase300(unittest.TestCase):
    """Test suite for Phase 300."""
    
    @classmethod
    def setUpClass(cls):
        """Set up test class."""
        cls.phase_num = 300
        cls.module_name = "core.engine.system3_phase300_phase_completion_validator"
        cls.func_name = "run_phase300"
