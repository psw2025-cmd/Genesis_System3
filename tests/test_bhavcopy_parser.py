...
def _udiif_df(symbol="NIFTY", opt_type="CE", strike=23000, oi=61295, oi_change=60905,
               volume=1500, ltp=350.0, fin_instrm_tp="IDO"):
    return pd.DataFrame([{
        "TckrSymb": symbol, "OptnTp": opt_type, "StrkPric": strike,
        "OpnIntrst": oi, "ChngInOpnIntrst": oi_change,
        "TtlTradgVol": volume, "ClsPric": ltp, "XpryDt": "2026-06-26",
        "FinInstrmTp": fin_instrm_tp, "UndrlygPric": 23622.9,
    }])


def _old_fmt_df(symbol="NIFTY", opt_type="PE", strike=22500, oi=50000, oi_change=-3000,
                volume=800, ltp=120.5):
    return pd.DataFrame([{
        "SYMBOL": symbol, "OPTION_TYP": opt_type, "STRIKE_PR": strike,
        "OPEN_INT": oi, "CHG_IN_OI": oi_change,
        "CONTRACTS": volume, "CLOSE": ltp, "INSTRUMENT": "OPTIDX",
...
def test_udiif_symbol_filter(dsm):
    rows = pd.DataFrame([
        {"TckrSymb": "NIFTY", "OptnTp": "CE", "StrkPric": 23000, "OpnIntrst": 100,
         "ChngInOpnIntrst": 50, "TtlTradgVol": 10, "ClsPric": 100.0,
         "XpryDt": "2026-06-26", "FinInstrmTp": "IDO", "UndrlygPric": 23622.9},
        {"TckrSymb": "BANKNIFTY", "OptnTp": "CE", "StrkPric": 48000, "OpnIntrst": 200,
         "ChngInOpnIntrst": 10, "TtlTradgVol": 20, "ClsPric": 200.0,
         "XpryDt": "2026-06-26", "FinInstrmTp": "IDO", "UndrlygPric": 54000.0},
    ])
...
def test_udiif_ce_pe_only(dsm):
    rows = pd.DataFrame([
        {"TckrSymb": "NIFTY", "OptnTp": "CE", "StrkPric": 23000, "OpnIntrst": 100,
         "ChngInOpnIntrst": 10, "TtlTradgVol": 10, "ClsPric": 100.0,
         "XpryDt": "2026-06-26", "FinInstrmTp": "IDO", "UndrlygPric": 23622.9},
        {"TckrSymb": "NIFTY", "OptnTp": "PE", "StrkPric": 23000, "OpnIntrst": 200,
         "ChngInOpnIntrst": -10, "TtlTradgVol": 20, "ClsPric": 80.0,
         "XpryDt": "2026-06-26", "FinInstrmTp": "IDO", "UndrlygPric": 23622.9},
        {"TckrSymb": "NIFTY", "OptnTp": "FUT", "StrkPric": 0, "OpnIntrst": 5000,
         "ChngInOpnIntrst": 100, "TtlTradgVol": 500, "ClsPric": 23600.0,
         "XpryDt": "2026-06-26", "FinInstrmTp": "IDX", "UndrlygPric": 23622.9},
    ])
    result, _ = dsm._parse_bhavcopy(rows, "NIFTY")
    assert result is not None
    assert len(result) == 2
