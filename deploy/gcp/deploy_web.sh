...
gcloud run deploy genesis-system3-web \
  ...
  --set-env-vars="SYSTEM3_DEPLOY_TARGET=gcp-cloud-run,SYSTEM3_STATE_BACKEND=firestore,SYSTEM3_STATE_BACKEND_REQUIRED=1,SYSTEM3_FIRESTORE_PROJECT=${PROJECT},SYSTEM3_STATE_REFRESH_S=5,SYSTEM3_SYNC_INTERVAL_S=60,SYSTEM3_REAL_ONLY=1,SYSTEM3_MODE=analyzer,ANALYZE_MODE=1,LIVE_TRADING_ENABLED=0,SYSTEM3_LIVE_TRADING_ALLOWED=0,CLOUD_PAPER_ENGINE=0,DEFER_INSTRUMENT_WARMUP=1,REQUIRE_API_KEY=false,MEM_WARN_MB=380,MEM_GC_MB=420,MEM_LIMIT_MB=480"
