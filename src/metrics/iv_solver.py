...
def black_scholes_vega(
    spot: float, strike: float, time_to_expiry: float, risk_free_rate: float, volatility: float
) -> float:
    """
...
def solve_iv_newton_raphson(
    ...
    return solve_iv_bisection(spot, strike, time_to_expiry, risk_free_rate, market_price, option_type)
...
def solve_implied_volatility(
    ...
    """
    if method == "newton":
        return solve_iv_newton_raphson(spot, strike, time_to_expiry, risk_free_rate, market_price, option_type)
    else:
        return solve_iv_bisection(spot, strike, time_to_expiry, risk_free_rate, market_price, option_type)
