...
class SchemaValidator:
    ...
    SCHEMAS = {
        'health.json': {
            'required': ['timestamp', 'is_running', 'is_connected', 'total_cycles', 
                        'trades_executed', 'current_positions', 'total_pnl', 'daily_pnl', 'mode'],
            'optional': ['last_data_fetch', 'successful_fetches', 'failed_fetches', 
                        'data_success_rate', 'signal_success_rate', 'signals_generated', 
                        'shutdown_time', 'qc_passed']
        },
        'qc_report_live.json': {
            'required': ['status', 'mode', 'timestamp', 'qc_passed'],
            'optional': ['reason', 'cycle', 'cycle_count', 'total_contracts', 'trade_signals',
                        'no_trade_signals', 'qc_failures', 'last_data_fetch']
        },
        'top_trade_signal.json': {
            'required': ['action', 'mode', 'timestamp', 'confidence'],
            'optional': ['underlying', 'symbol', 'strategy', 'reason', 'reasons', 'tokens', 
                        'strikes', 'entry_mid', 'stop_loss', 'target']
        },
        'chain_raw_live.csv': {
            'required_columns': ['status'],  # At minimum, status column must exist
            'optional_columns': ['underlying', 'strike', 'option_type', 'ltp', 'bid', 'ask',
                               'oi', 'iv', 'timestamp', 'mode', 'reason', 'cycle']
        },
