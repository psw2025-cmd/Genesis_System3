"""
Angel One SmartAPI WebSocket — DISABLED.

System3 is Dhan-only. The SmartAPI WebSocket data path is not operational.
...
DISABLED_REASON = (
    "Angel One SmartAPI WebSocket path is disabled. "
...
class LiveChainWebSocket:
    """
    Disabled Angel One WebSocket shim.
